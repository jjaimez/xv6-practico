...
801007b9:	e8 ac 6b 00 00       	call   8010736a <uartputc>
...
801037d6:	e8 39 47 00 00       	call   80107f14 <seginit>
  cprintf("\ncpu%d: starting xv6\n\n", cpu->id);
...
80103807:	e8 6b 3a 00 00       	call   80107277 <uartinit>
  pinit();         // process table
...
80103862:	e8 1c 4d 00 00       	call   80108583 <switchkvm>
  seginit();
80103867:	e8 a8 46 00 00       	call   80107f14 <seginit>
  lapicinit();
...
80106f23:	e8 b6 da ff ff       	call   801049de <exit>
    return;
80106f28:	e9 07 03 00 00       	jmp    80107234 <trap+0x355>
80106f2d:	e9 02 03 00 00       	jmp    80107234 <trap+0x355>
  }

  switch(tf->trapno){
80106f32:	8b 45 08             	mov    0x8(%ebp),%eax
80106f35:	8b 40 30             	mov    0x30(%eax),%eax
80106f38:	83 e8 20             	sub    $0x20,%eax
80106f3b:	83 f8 1f             	cmp    $0x1f,%eax
80106f3e:	0f 87 c0 00 00 00    	ja     80107004 <trap+0x125>
80106f44:	8b 04 85 f0 91 10 80 	mov    -0x7fef6e10(,%eax,4),%eax
...
80106f97:	e8 9f bf ff ff       	call   80102f3b <lapiceoi>
    break;
80106f9c:	e9 f2 01 00 00       	jmp    80107193 <trap+0x2b4>
  case T_IRQ0 + IRQ_IDE:
    ideintr();
...
80106fa6:	e8 90 bf ff ff       	call   80102f3b <lapiceoi>
    break;
80106fab:	e9 e3 01 00 00       	jmp    80107193 <trap+0x2b4>
...
80106fb5:	e8 81 bf ff ff       	call   80102f3b <lapiceoi>
    break;
80106fba:	e9 d4 01 00 00       	jmp    80107193 <trap+0x2b4>
  case T_IRQ0 + IRQ_COM1:
    uartintr();
80106fbf:	e8 4d 04 00 00       	call   80107411 <uartintr>
    lapiceoi();
80106fc4:	e8 72 bf ff ff       	call   80102f3b <lapiceoi>
    break;
80106fc9:	e9 c5 01 00 00       	jmp    80107193 <trap+0x2b4>
  case T_IRQ0 + 7:
...
80106ffa:	e8 3c bf ff ff       	call   80102f3b <lapiceoi>
    break;
80106fff:	e9 8f 01 00 00       	jmp    80107193 <trap+0x2b4>
...
8010700c:	74 11                	je     8010701f <trap+0x140>
8010700e:	8b 45 08             	mov    0x8(%ebp),%eax
80107011:	0f b7 40 3c          	movzwl 0x3c(%eax),%eax
80107015:	0f b7 c0             	movzwl %ax,%eax
80107018:	83 e0 03             	and    $0x3,%eax
8010701b:	85 c0                	test   %eax,%eax
8010701d:	75 40                	jne    8010705f <trap+0x180>
      // In kernel, it must be our mistake.
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
8010701f:	e8 1e fd ff ff       	call   80106d42 <rcr2>
80107024:	89 c3                	mov    %eax,%ebx
80107026:	8b 45 08             	mov    0x8(%ebp),%eax
80107029:	8b 48 38             	mov    0x38(%eax),%ecx
              tf->trapno, cpu->id, tf->eip, rcr2());
8010702c:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80107032:	0f b6 00             	movzbl (%eax),%eax
  ...
  default:
    if(proc == 0 || (tf->cs&3) == 0){
      // In kernel, it must be our mistake.
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
80107035:	0f b6 d0             	movzbl %al,%edx
80107038:	8b 45 08             	mov    0x8(%ebp),%eax
8010703b:	8b 40 30             	mov    0x30(%eax),%eax
8010703e:	83 ec 0c             	sub    $0xc,%esp
80107041:	53                   	push   %ebx
80107042:	51                   	push   %ecx
80107043:	52                   	push   %edx
80107044:	50                   	push   %eax
80107045:	68 54 91 10 80       	push   $0x80109154
8010704a:	e8 70 93 ff ff       	call   801003bf <cprintf>
...
80107068:	0f 85 c7 00 00 00    	jne    80107135 <trap+0x256>
8010706e:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80107074:	85 c0                	test   %eax,%eax
80107076:	0f 84 b9 00 00 00    	je     80107135 <trap+0x256>
8010707c:	e8 c1 fc ff ff       	call   80106d42 <rcr2>
80107081:	89 c3                	mov    %eax,%ebx
80107083:	e8 ba fc ff ff       	call   80106d42 <rcr2>
80107088:	05 ff 0f 00 00       	add    $0xfff,%eax
...
801070cf:	68 8b 91 10 80       	push   $0x8010918b
801070d4:	e8 e6 92 ff ff       	call   801003bf <cprintf>
801070d9:	83 c4 10             	add    $0x10,%esp
      allocuvm(proc->pgdir, PGROUNDDOWN(rcr2()), PGROUNDUP(rcr2()));
801070dc:	e8 61 fc ff ff       	call   80106d42 <rcr2>
801070e1:	05 ff 0f 00 00       	add    $0xfff,%eax
801070e6:	25 00 f0 ff ff       	and    $0xfffff000,%eax
801070eb:	89 c3                	mov    %eax,%ebx
801070ed:	e8 50 fc ff ff       	call   80106d42 <rcr2>
801070f2:	25 00 f0 ff ff       	and    $0xfffff000,%eax
801070f7:	89 c2                	mov    %eax,%edx
801070f9:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801070ff:	8b 40 04             	mov    0x4(%eax),%eax
80107102:	83 ec 04             	sub    $0x4,%esp
80107105:	53                   	push   %ebx
80107106:	52                   	push   %edx
80107107:	50                   	push   %eax
80107108:	e8 50 17 00 00       	call   8010885d <allocuvm>
8010710d:	83 c4 10             	add    $0x10,%esp
        cprintf("alloco %d \n" , ++i);
80107110:	a1 6c c6 10 80       	mov    0x8010c66c,%eax
80107115:	83 c0 01             	add    $0x1,%eax
80107118:	a3 6c c6 10 80       	mov    %eax,0x8010c66c
8010711d:	a1 6c c6 10 80       	mov    0x8010c66c,%eax
80107122:	83 ec 08             	sub    $0x8,%esp
80107125:	50                   	push   %eax
80107126:	68 9e 91 10 80       	push   $0x8010919e
8010712b:	e8 8f 92 ff ff       	call   801003bf <cprintf>
80107130:	83 c4 10             	add    $0x10,%esp
80107133:	eb 5e                	jmp    80107193 <trap+0x2b4>
      }else{
      // In user space, assume process misbehaved.
      cprintf("pid %d %s: trap %d err %d on cpu %d "
80107135:	e8 08 fc ff ff       	call   80106d42 <rcr2>
8010713a:	89 45 e4             	mov    %eax,-0x1c(%ebp)
8010713d:	8b 45 08             	mov    0x8(%ebp),%eax
80107140:	8b 70 38             	mov    0x38(%eax),%esi
              "eip 0x%x addr 0x%x--kill proc\n",
              proc->pid, proc->name, tf->trapno, tf->err, cpu->id, tf->eip, 
80107143:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80107149:	0f b6 00             	movzbl (%eax),%eax
        cprintf("estoy por alocar \n");
      allocuvm(proc->pgdir, PGROUNDDOWN(rcr2()), PGROUNDUP(rcr2()));
        cprintf("alloco %d \n" , ++i);
      }else{
      // In user space, assume process misbehaved.
      cprintf("pid %d %s: trap %d err %d on cpu %d "
8010714c:	0f b6 d8             	movzbl %al,%ebx
8010714f:	8b 45 08             	mov    0x8(%ebp),%eax
80107152:	8b 48 34             	mov    0x34(%eax),%ecx
80107155:	8b 45 08             	mov    0x8(%ebp),%eax
80107158:	8b 50 30             	mov    0x30(%eax),%edx
              "eip 0x%x addr 0x%x--kill proc\n",
              proc->pid, proc->name, tf->trapno, tf->err, cpu->id, tf->eip, 
8010715b:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80107161:	8d 78 6c             	lea    0x6c(%eax),%edi
80107164:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
      ...
      // In user space, assume process misbehaved.
      cprintf("pid %d %s: trap %d err %d on cpu %d "
8010716a:	8b 40 10             	mov    0x10(%eax),%eax
8010716d:	ff 75 e4             	pushl  -0x1c(%ebp)
80107170:	56                   	push   %esi
80107171:	53                   	push   %ebx
80107172:	51                   	push   %ecx
80107173:	52                   	push   %edx
80107174:	57                   	push   %edi
80107175:	50                   	push   %eax
80107176:	68 ac 91 10 80       	push   $0x801091ac
8010717b:	e8 3f 92 ff ff       	call   801003bf <cprintf>
80107180:	83 c4 20             	add    $0x20,%esp
              "eip 0x%x addr 0x%x--kill proc\n",
              proc->pid, proc->name, tf->trapno, tf->err, cpu->id, tf->eip, 
              rcr2());
      proc->killed = 1;
80107183:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80107189:	c7 40 24 01 00 00 00 	movl   $0x1,0x24(%eax)
80107190:	eb 01                	jmp    80107193 <trap+0x2b4>
    ideintr();
    lapiceoi();
    break;
  case T_IRQ0 + IRQ_IDE+1:
...
8010719b:	74 24                	je     801071c1 <trap+0x2e2>
8010719d:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801071a3:	8b 40 24             	mov    0x24(%eax),%eax
801071a6:	85 c0                	test   %eax,%eax
801071a8:	74 17                	je     801071c1 <trap+0x2e2>
801071aa:	8b 45 08             	mov    0x8(%ebp),%eax
801071ad:	0f b7 40 3c          	movzwl 0x3c(%eax),%eax
801071b1:	0f b7 c0             	movzwl %ax,%eax
801071b4:	83 e0 03             	and    $0x3,%eax
801071b7:	83 f8 03             	cmp    $0x3,%eax
801071ba:	75 05                	jne    801071c1 <trap+0x2e2>
    exit();
801071bc:	e8 1d d8 ff ff       	call   801049de <exit>
...
801071c9:	74 3b                	je     80107206 <trap+0x327>
801071cb:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801071d1:	8b 40 0c             	mov    0xc(%eax),%eax
801071d4:	83 f8 04             	cmp    $0x4,%eax
801071d7:	75 2d                	jne    80107206 <trap+0x327>
801071d9:	8b 45 08             	mov    0x8(%ebp),%eax
801071dc:	8b 40 30             	mov    0x30(%eax),%eax
801071df:	83 f8 20             	cmp    $0x20,%eax
801071e2:	75 22                	jne    80107206 <trap+0x327>
    proc->quantum++;   // increases the quantum ticks counter
801071e4:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801071ea:	8b 50 7c             	mov    0x7c(%eax),%edx
801071ed:	83 c2 01             	add    $0x1,%edx
801071f0:	89 50 7c             	mov    %edx,0x7c(%eax)
    if (proc->quantum >= QUANTUM){ 
801071f3:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801071f9:	8b 40 7c             	mov    0x7c(%eax),%eax
801071fc:	83 f8 02             	cmp    $0x2,%eax
801071ff:	7e 05                	jle    80107206 <trap+0x327>
      yield();
80107201:	e8 14 dc ff ff       	call   80104e1a <yield>
    }
  }   

  // Check if the process has been killed since we yielded
  if(proc && proc->killed && (tf->cs&3) == DPL_USER)
80107206:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
8010720c:	85 c0                	test   %eax,%eax
8010720e:	74 24                	je     80107234 <trap+0x355>
80107210:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80107216:	8b 40 24             	mov    0x24(%eax),%eax
80107219:	85 c0                	test   %eax,%eax
8010721b:	74 17                	je     80107234 <trap+0x355>
8010721d:	8b 45 08             	mov    0x8(%ebp),%eax
80107220:	0f b7 40 3c          	movzwl 0x3c(%eax),%eax
80107224:	0f b7 c0             	movzwl %ax,%eax
80107227:	83 e0 03             	and    $0x3,%eax
8010722a:	83 f8 03             	cmp    $0x3,%eax
8010722d:	75 05                	jne    80107234 <trap+0x355>
    exit();
8010722f:	e8 aa d7 ff ff       	call   801049de <exit>
}
...
8010723f:	83 ec 14             	sub    $0x14,%esp
80107242:	8b 45 08             	mov    0x8(%ebp),%eax
80107245:	66 89 45 ec          	mov    %ax,-0x14(%ebp)
  uchar data;

  asm volatile("in %1,%0" : "=a" (data) : "d" (port));
80107249:	0f b7 45 ec          	movzwl -0x14(%ebp),%eax
8010724d:	89 c2                	mov    %eax,%edx
8010724f:	ec                   	in     (%dx),%al
80107250:	88 45 ff             	mov    %al,-0x1(%ebp)
  return data;
80107253:	0f b6 45 ff          	movzbl -0x1(%ebp),%eax
}
80107257:	c9                   	leave  
80107258:	c3                   	ret    
...
8010725f:	8b 55 08             	mov    0x8(%ebp),%edx
80107262:	8b 45 0c             	mov    0xc(%ebp),%eax
80107265:	66 89 55 fc          	mov    %dx,-0x4(%ebp)
80107269:	88 45 f8             	mov    %al,-0x8(%ebp)
  asm volatile("out %0,%1" : : "a" (data), "d" (port));
8010726c:	0f b6 45 f8          	movzbl -0x8(%ebp),%eax
80107270:	0f b7 55 fc          	movzwl -0x4(%ebp),%edx
...
8010727a:	83 ec 18             	sub    $0x18,%esp
  char *p;

  // Turn off the FIFO
  outb(COM1+2, 0);
8010727d:	6a 00                	push   $0x0
8010727f:	68 fa 03 00 00       	push   $0x3fa
80107284:	e8 d0 ff ff ff       	call   80107259 <outb>
80107289:	83 c4 08             	add    $0x8,%esp
  
  // 9600 baud, 8 data bits, 1 stop bit, parity off.
  outb(COM1+3, 0x80);    // Unlock divisor
8010728c:	68 80 00 00 00       	push   $0x80
80107291:	68 fb 03 00 00       	push   $0x3fb
80107296:	e8 be ff ff ff       	call   80107259 <outb>
8010729b:	83 c4 08             	add    $0x8,%esp
  outb(COM1+0, 115200/9600);
8010729e:	6a 0c                	push   $0xc
801072a0:	68 f8 03 00 00       	push   $0x3f8
801072a5:	e8 af ff ff ff       	call   80107259 <outb>
801072aa:	83 c4 08             	add    $0x8,%esp
  outb(COM1+1, 0);
801072ad:	6a 00                	push   $0x0
801072af:	68 f9 03 00 00       	push   $0x3f9
801072b4:	e8 a0 ff ff ff       	call   80107259 <outb>
801072b9:	83 c4 08             	add    $0x8,%esp
  outb(COM1+3, 0x03);    // Lock divisor, 8 data bits.
801072bc:	6a 03                	push   $0x3
801072be:	68 fb 03 00 00       	push   $0x3fb
801072c3:	e8 91 ff ff ff       	call   80107259 <outb>
801072c8:	83 c4 08             	add    $0x8,%esp
  outb(COM1+4, 0);
801072cb:	6a 00                	push   $0x0
801072cd:	68 fc 03 00 00       	push   $0x3fc
801072d2:	e8 82 ff ff ff       	call   80107259 <outb>
801072d7:	83 c4 08             	add    $0x8,%esp
  outb(COM1+1, 0x01);    // Enable receive interrupts.
801072da:	6a 01                	push   $0x1
801072dc:	68 f9 03 00 00       	push   $0x3f9
801072e1:	e8 73 ff ff ff       	call   80107259 <outb>
801072e6:	83 c4 08             	add    $0x8,%esp

  // If status is 0xFF, no serial port.
  if(inb(COM1+5) == 0xFF)
801072e9:	68 fd 03 00 00       	push   $0x3fd
801072ee:	e8 49 ff ff ff       	call   8010723c <inb>
801072f3:	83 c4 04             	add    $0x4,%esp
801072f6:	3c ff                	cmp    $0xff,%al
801072f8:	75 02                	jne    801072fc <uartinit+0x85>
    return;
801072fa:	eb 6c                	jmp    80107368 <uartinit+0xf1>
  uart = 1;
801072fc:	c7 05 70 c6 10 80 01 	movl   $0x1,0x8010c670
80107303:	00 00 00 

  // Acknowledge pre-existing interrupt conditions;
  // enable interrupts.
  inb(COM1+2);
80107306:	68 fa 03 00 00       	push   $0x3fa
8010730b:	e8 2c ff ff ff       	call   8010723c <inb>
80107310:	83 c4 04             	add    $0x4,%esp
  inb(COM1+0);
80107313:	68 f8 03 00 00       	push   $0x3f8
80107318:	e8 1f ff ff ff       	call   8010723c <inb>
8010731d:	83 c4 04             	add    $0x4,%esp
  picenable(IRQ_COM1);
80107320:	83 ec 0c             	sub    $0xc,%esp
80107323:	6a 04                	push   $0x4
80107325:	e8 11 cb ff ff       	call   80103e3b <picenable>
8010732a:	83 c4 10             	add    $0x10,%esp
  ioapicenable(IRQ_COM1, 0);
8010732d:	83 ec 08             	sub    $0x8,%esp
80107330:	6a 00                	push   $0x0
80107332:	6a 04                	push   $0x4
80107334:	e8 c1 b6 ff ff       	call   801029fa <ioapicenable>
80107339:	83 c4 10             	add    $0x10,%esp
  
  // Announce that we're here.
  for(p="xv6...\n"; *p; p++)
8010733c:	c7 45 f4 70 92 10 80 	movl   $0x80109270,-0xc(%ebp)
80107343:	eb 19                	jmp    8010735e <uartinit+0xe7>
    uartputc(*p);
80107345:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107348:	0f b6 00             	movzbl (%eax),%eax
8010734b:	0f be c0             	movsbl %al,%eax
8010734e:	83 ec 0c             	sub    $0xc,%esp
80107351:	50                   	push   %eax
80107352:	e8 13 00 00 00       	call   8010736a <uartputc>
80107357:	83 c4 10             	add    $0x10,%esp
  ...
  // Announce that we're here.
  for(p="xv6...\n"; *p; p++)
8010735a:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
8010735e:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107361:	0f b6 00             	movzbl (%eax),%eax
80107364:	84 c0                	test   %al,%al
80107366:	75 dd                	jne    80107345 <uartinit+0xce>
    uartputc(*p);
}
80107368:	c9                   	leave  
80107369:	c3                   	ret    
...
8010736d:	83 ec 18             	sub    $0x18,%esp
  ...
  if(!uart)
80107370:	a1 70 c6 10 80       	mov    0x8010c670,%eax
80107375:	85 c0                	test   %eax,%eax
80107377:	75 02                	jne    8010737b <uartputc+0x11>
    return;
80107379:	eb 51                	jmp    801073cc <uartputc+0x62>
  for(i = 0; i < 128 && !(inb(COM1+5) & 0x20); i++)
8010737b:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
80107382:	eb 11                	jmp    80107395 <uartputc+0x2b>
    microdelay(10);
80107384:	83 ec 0c             	sub    $0xc,%esp
80107387:	6a 0a                	push   $0xa
80107389:	e8 c7 bb ff ff       	call   80102f55 <microdelay>
8010738e:	83 c4 10             	add    $0x10,%esp
{
  ...
  if(!uart)
    return;
  for(i = 0; i < 128 && !(inb(COM1+5) & 0x20); i++)
80107391:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
80107395:	83 7d f4 7f          	cmpl   $0x7f,-0xc(%ebp)
80107399:	7f 1a                	jg     801073b5 <uartputc+0x4b>
8010739b:	83 ec 0c             	sub    $0xc,%esp
8010739e:	68 fd 03 00 00       	push   $0x3fd
801073a3:	e8 94 fe ff ff       	call   8010723c <inb>
801073a8:	83 c4 10             	add    $0x10,%esp
801073ab:	0f b6 c0             	movzbl %al,%eax
801073ae:	83 e0 20             	and    $0x20,%eax
801073b1:	85 c0                	test   %eax,%eax
801073b3:	74 cf                	je     80107384 <uartputc+0x1a>
    microdelay(10);
  outb(COM1+0, c);
801073b5:	8b 45 08             	mov    0x8(%ebp),%eax
801073b8:	0f b6 c0             	movzbl %al,%eax
801073bb:	83 ec 08             	sub    $0x8,%esp
801073be:	50                   	push   %eax
801073bf:	68 f8 03 00 00       	push   $0x3f8
801073c4:	e8 90 fe ff ff       	call   80107259 <outb>
...
801073cf:	89 e5                	mov    %esp,%ebp
  if(!uart)
801073d1:	a1 70 c6 10 80       	mov    0x8010c670,%eax
801073d6:	85 c0                	test   %eax,%eax
801073d8:	75 07                	jne    801073e1 <uartgetc+0x13>
    return -1;
801073da:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801073df:	eb 2e                	jmp    8010740f <uartgetc+0x41>
  if(!(inb(COM1+5) & 0x01))
801073e1:	68 fd 03 00 00       	push   $0x3fd
801073e6:	e8 51 fe ff ff       	call   8010723c <inb>
801073eb:	83 c4 04             	add    $0x4,%esp
801073ee:	0f b6 c0             	movzbl %al,%eax
801073f1:	83 e0 01             	and    $0x1,%eax
801073f4:	85 c0                	test   %eax,%eax
801073f6:	75 07                	jne    801073ff <uartgetc+0x31>
    return -1;
801073f8:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801073fd:	eb 10                	jmp    8010740f <uartgetc+0x41>
  return inb(COM1+0);
801073ff:	68 f8 03 00 00       	push   $0x3f8
80107404:	e8 33 fe ff ff       	call   8010723c <inb>
80107409:	83 c4 04             	add    $0x4,%esp
8010740c:	0f b6 c0             	movzbl %al,%eax
}
8010740f:	c9                   	leave  
80107410:	c3                   	ret    
...
8010741a:	68 ce 73 10 80       	push   $0x801073ce
8010741f:	e8 ad 93 ff ff       	call   801007d1 <consoleintr>
...
8010742b:	6a 00                	push   $0x0
  jmp alltraps
8010742d:	e9 bc f8 ff ff       	jmp    80106cee <alltraps>
...
80107432:	6a 00                	push   $0x0
  pushl $1
80107434:	6a 01                	push   $0x1
  jmp alltraps
80107436:	e9 b3 f8 ff ff       	jmp    80106cee <alltraps>
...
8010743b:	6a 00                	push   $0x0
  pushl $2
8010743d:	6a 02                	push   $0x2
  jmp alltraps
8010743f:	e9 aa f8 ff ff       	jmp    80106cee <alltraps>
...
80107444:	6a 00                	push   $0x0
  pushl $3
80107446:	6a 03                	push   $0x3
  jmp alltraps
80107448:	e9 a1 f8 ff ff       	jmp    80106cee <alltraps>
...
8010744d:	6a 00                	push   $0x0
  pushl $4
8010744f:	6a 04                	push   $0x4
  jmp alltraps
80107451:	e9 98 f8 ff ff       	jmp    80106cee <alltraps>
...
80107456:	6a 00                	push   $0x0
  pushl $5
80107458:	6a 05                	push   $0x5
  jmp alltraps
8010745a:	e9 8f f8 ff ff       	jmp    80106cee <alltraps>
...
8010745f:	6a 00                	push   $0x0
  pushl $6
80107461:	6a 06                	push   $0x6
  jmp alltraps
80107463:	e9 86 f8 ff ff       	jmp    80106cee <alltraps>
...
80107468:	6a 00                	push   $0x0
  pushl $7
8010746a:	6a 07                	push   $0x7
  jmp alltraps
8010746c:	e9 7d f8 ff ff       	jmp    80106cee <alltraps>

80107471 <vector8>:
.globl vector8
vector8:
  pushl $8
80107471:	6a 08                	push   $0x8
  jmp alltraps
...
vector10:
  pushl $10
80107481:	6a 0a                	push   $0xa
  jmp alltraps
80107483:	e9 66 f8 ff ff       	jmp    80106cee <alltraps>

80107488 <vector11>:
.globl vector11
vector11:
  pushl $11
80107488:	6a 0b                	push   $0xb
  jmp alltraps
8010748a:	e9 5f f8 ff ff       	jmp    80106cee <alltraps>

8010748f <vector12>:
.globl vector12
vector12:
  pushl $12
8010748f:	6a 0c                	push   $0xc
  jmp alltraps
80107491:	e9 58 f8 ff ff       	jmp    80106cee <alltraps>

80107496 <vector13>:
.globl vector13
vector13:
  pushl $13
80107496:	6a 0d                	push   $0xd
  jmp alltraps
80107498:	e9 51 f8 ff ff       	jmp    80106cee <alltraps>

8010749d <vector14>:
.globl vector14
vector14:
  pushl $14
8010749d:	6a 0e                	push   $0xe
  jmp alltraps
8010749f:	e9 4a f8 ff ff       	jmp    80106cee <alltraps>
...
801074a4:	6a 00                	push   $0x0
  pushl $15
801074a6:	6a 0f                	push   $0xf
  jmp alltraps
801074a8:	e9 41 f8 ff ff       	jmp    80106cee <alltraps>
...
801074cf:	6a 00                	push   $0x0
  pushl $20
801074d1:	6a 14                	push   $0x14
  jmp alltraps
801074d3:	e9 16 f8 ff ff       	jmp    80106cee <alltraps>
...
801074d8:	6a 00                	push   $0x0
  pushl $21
801074da:	6a 15                	push   $0x15
  jmp alltraps
801074dc:	e9 0d f8 ff ff       	jmp    80106cee <alltraps>
...
801074e1:	6a 00                	push   $0x0
  pushl $22
801074e3:	6a 16                	push   $0x16
  jmp alltraps
801074e5:	e9 04 f8 ff ff       	jmp    80106cee <alltraps>
...
801074ea:	6a 00                	push   $0x0
  pushl $23
801074ec:	6a 17                	push   $0x17
  jmp alltraps
801074ee:	e9 fb f7 ff ff       	jmp    80106cee <alltraps>
...
801074f3:	6a 00                	push   $0x0
  pushl $24
801074f5:	6a 18                	push   $0x18
  jmp alltraps
801074f7:	e9 f2 f7 ff ff       	jmp    80106cee <alltraps>
...
801074fc:	6a 00                	push   $0x0
  pushl $25
801074fe:	6a 19                	push   $0x19
  jmp alltraps
80107500:	e9 e9 f7 ff ff       	jmp    80106cee <alltraps>
...
80107505:	6a 00                	push   $0x0
  pushl $26
80107507:	6a 1a                	push   $0x1a
  jmp alltraps
80107509:	e9 e0 f7 ff ff       	jmp    80106cee <alltraps>
...
8010750e:	6a 00                	push   $0x0
  pushl $27
80107510:	6a 1b                	push   $0x1b
  jmp alltraps
80107512:	e9 d7 f7 ff ff       	jmp    80106cee <alltraps>
...
80107517:	6a 00                	push   $0x0
  pushl $28
80107519:	6a 1c                	push   $0x1c
  jmp alltraps
8010751b:	e9 ce f7 ff ff       	jmp    80106cee <alltraps>
...
80107520:	6a 00                	push   $0x0
  pushl $29
80107522:	6a 1d                	push   $0x1d
  jmp alltraps
80107524:	e9 c5 f7 ff ff       	jmp    80106cee <alltraps>
...
80107529:	6a 00                	push   $0x0
  pushl $30
8010752b:	6a 1e                	push   $0x1e
  jmp alltraps
8010752d:	e9 bc f7 ff ff       	jmp    80106cee <alltraps>
...
80107532:	6a 00                	push   $0x0
  pushl $31
80107534:	6a 1f                	push   $0x1f
  jmp alltraps
80107536:	e9 b3 f7 ff ff       	jmp    80106cee <alltraps>
...
8010753b:	6a 00                	push   $0x0
  pushl $32
8010753d:	6a 20                	push   $0x20
  jmp alltraps
8010753f:	e9 aa f7 ff ff       	jmp    80106cee <alltraps>
...
80107544:	6a 00                	push   $0x0
  pushl $33
80107546:	6a 21                	push   $0x21
  jmp alltraps
80107548:	e9 a1 f7 ff ff       	jmp    80106cee <alltraps>
...
8010754d:	6a 00                	push   $0x0
  pushl $34
8010754f:	6a 22                	push   $0x22
  jmp alltraps
80107551:	e9 98 f7 ff ff       	jmp    80106cee <alltraps>
...
80107556:	6a 00                	push   $0x0
  pushl $35
80107558:	6a 23                	push   $0x23
  jmp alltraps
8010755a:	e9 8f f7 ff ff       	jmp    80106cee <alltraps>
...
8010755f:	6a 00                	push   $0x0
  pushl $36
80107561:	6a 24                	push   $0x24
  jmp alltraps
80107563:	e9 86 f7 ff ff       	jmp    80106cee <alltraps>
...
80107568:	6a 00                	push   $0x0
  pushl $37
8010756a:	6a 25                	push   $0x25
  jmp alltraps
8010756c:	e9 7d f7 ff ff       	jmp    80106cee <alltraps>
...
80107571:	6a 00                	push   $0x0
  pushl $38
80107573:	6a 26                	push   $0x26
  jmp alltraps
80107575:	e9 74 f7 ff ff       	jmp    80106cee <alltraps>
...
8010757a:	6a 00                	push   $0x0
  pushl $39
8010757c:	6a 27                	push   $0x27
  jmp alltraps
8010757e:	e9 6b f7 ff ff       	jmp    80106cee <alltraps>
...
80107583:	6a 00                	push   $0x0
  pushl $40
80107585:	6a 28                	push   $0x28
  jmp alltraps
80107587:	e9 62 f7 ff ff       	jmp    80106cee <alltraps>
...
8010758c:	6a 00                	push   $0x0
  pushl $41
8010758e:	6a 29                	push   $0x29
  jmp alltraps
80107590:	e9 59 f7 ff ff       	jmp    80106cee <alltraps>
...
80107595:	6a 00                	push   $0x0
  pushl $42
80107597:	6a 2a                	push   $0x2a
  jmp alltraps
80107599:	e9 50 f7 ff ff       	jmp    80106cee <alltraps>
...
8010759e:	6a 00                	push   $0x0
  pushl $43
801075a0:	6a 2b                	push   $0x2b
  jmp alltraps
801075a2:	e9 47 f7 ff ff       	jmp    80106cee <alltraps>
...
801075a7:	6a 00                	push   $0x0
  pushl $44
801075a9:	6a 2c                	push   $0x2c
  jmp alltraps
801075ab:	e9 3e f7 ff ff       	jmp    80106cee <alltraps>
...
801075b0:	6a 00                	push   $0x0
  pushl $45
801075b2:	6a 2d                	push   $0x2d
  jmp alltraps
801075b4:	e9 35 f7 ff ff       	jmp    80106cee <alltraps>
...
801075b9:	6a 00                	push   $0x0
  pushl $46
801075bb:	6a 2e                	push   $0x2e
  jmp alltraps
801075bd:	e9 2c f7 ff ff       	jmp    80106cee <alltraps>
...
801075c2:	6a 00                	push   $0x0
  pushl $47
801075c4:	6a 2f                	push   $0x2f
  jmp alltraps
801075c6:	e9 23 f7 ff ff       	jmp    80106cee <alltraps>
...
801075cb:	6a 00                	push   $0x0
  pushl $48
801075cd:	6a 30                	push   $0x30
  jmp alltraps
801075cf:	e9 1a f7 ff ff       	jmp    80106cee <alltraps>
...
801075d4:	6a 00                	push   $0x0
  pushl $49
801075d6:	6a 31                	push   $0x31
  jmp alltraps
801075d8:	e9 11 f7 ff ff       	jmp    80106cee <alltraps>
...
801075dd:	6a 00                	push   $0x0
  pushl $50
801075df:	6a 32                	push   $0x32
  jmp alltraps
801075e1:	e9 08 f7 ff ff       	jmp    80106cee <alltraps>
...
801075e6:	6a 00                	push   $0x0
  pushl $51
801075e8:	6a 33                	push   $0x33
  jmp alltraps
801075ea:	e9 ff f6 ff ff       	jmp    80106cee <alltraps>
...
801075ef:	6a 00                	push   $0x0
  pushl $52
801075f1:	6a 34                	push   $0x34
  jmp alltraps
801075f3:	e9 f6 f6 ff ff       	jmp    80106cee <alltraps>
...
801075f8:	6a 00                	push   $0x0
  pushl $53
801075fa:	6a 35                	push   $0x35
  jmp alltraps
801075fc:	e9 ed f6 ff ff       	jmp    80106cee <alltraps>
...
80107601:	6a 00                	push   $0x0
  pushl $54
80107603:	6a 36                	push   $0x36
  jmp alltraps
80107605:	e9 e4 f6 ff ff       	jmp    80106cee <alltraps>
...
8010760a:	6a 00                	push   $0x0
  pushl $55
8010760c:	6a 37                	push   $0x37
  jmp alltraps
8010760e:	e9 db f6 ff ff       	jmp    80106cee <alltraps>
...
80107613:	6a 00                	push   $0x0
  pushl $56
80107615:	6a 38                	push   $0x38
  jmp alltraps
80107617:	e9 d2 f6 ff ff       	jmp    80106cee <alltraps>
...
8010761c:	6a 00                	push   $0x0
  pushl $57
8010761e:	6a 39                	push   $0x39
  jmp alltraps
80107620:	e9 c9 f6 ff ff       	jmp    80106cee <alltraps>
...
80107625:	6a 00                	push   $0x0
  pushl $58
80107627:	6a 3a                	push   $0x3a
  jmp alltraps
80107629:	e9 c0 f6 ff ff       	jmp    80106cee <alltraps>
...
8010762e:	6a 00                	push   $0x0
  pushl $59
80107630:	6a 3b                	push   $0x3b
  jmp alltraps
80107632:	e9 b7 f6 ff ff       	jmp    80106cee <alltraps>
...
80107637:	6a 00                	push   $0x0
  pushl $60
80107639:	6a 3c                	push   $0x3c
  jmp alltraps
8010763b:	e9 ae f6 ff ff       	jmp    80106cee <alltraps>
...
80107640:	6a 00                	push   $0x0
  pushl $61
80107642:	6a 3d                	push   $0x3d
  jmp alltraps
80107644:	e9 a5 f6 ff ff       	jmp    80106cee <alltraps>
...
80107649:	6a 00                	push   $0x0
  pushl $62
8010764b:	6a 3e                	push   $0x3e
  jmp alltraps
8010764d:	e9 9c f6 ff ff       	jmp    80106cee <alltraps>
...
80107652:	6a 00                	push   $0x0
  pushl $63
80107654:	6a 3f                	push   $0x3f
  jmp alltraps
80107656:	e9 93 f6 ff ff       	jmp    80106cee <alltraps>
...
8010765b:	6a 00                	push   $0x0
  pushl $64
8010765d:	6a 40                	push   $0x40
  jmp alltraps
8010765f:	e9 8a f6 ff ff       	jmp    80106cee <alltraps>
...
80107664:	6a 00                	push   $0x0
  pushl $65
80107666:	6a 41                	push   $0x41
  jmp alltraps
80107668:	e9 81 f6 ff ff       	jmp    80106cee <alltraps>
...
8010766d:	6a 00                	push   $0x0
  pushl $66
8010766f:	6a 42                	push   $0x42
  jmp alltraps
80107671:	e9 78 f6 ff ff       	jmp    80106cee <alltraps>
...
80107676:	6a 00                	push   $0x0
  pushl $67
80107678:	6a 43                	push   $0x43
  jmp alltraps
8010767a:	e9 6f f6 ff ff       	jmp    80106cee <alltraps>
...
8010767f:	6a 00                	push   $0x0
  pushl $68
80107681:	6a 44                	push   $0x44
  jmp alltraps
80107683:	e9 66 f6 ff ff       	jmp    80106cee <alltraps>
...
80107688:	6a 00                	push   $0x0
  pushl $69
8010768a:	6a 45                	push   $0x45
  jmp alltraps
8010768c:	e9 5d f6 ff ff       	jmp    80106cee <alltraps>
...
80107691:	6a 00                	push   $0x0
  pushl $70
80107693:	6a 46                	push   $0x46
  jmp alltraps
80107695:	e9 54 f6 ff ff       	jmp    80106cee <alltraps>
...
8010769a:	6a 00                	push   $0x0
  pushl $71
8010769c:	6a 47                	push   $0x47
  jmp alltraps
8010769e:	e9 4b f6 ff ff       	jmp    80106cee <alltraps>
...
801076a3:	6a 00                	push   $0x0
  pushl $72
801076a5:	6a 48                	push   $0x48
  jmp alltraps
801076a7:	e9 42 f6 ff ff       	jmp    80106cee <alltraps>
...
801076ac:	6a 00                	push   $0x0
  pushl $73
801076ae:	6a 49                	push   $0x49
  jmp alltraps
801076b0:	e9 39 f6 ff ff       	jmp    80106cee <alltraps>
...
801076b5:	6a 00                	push   $0x0
  pushl $74
801076b7:	6a 4a                	push   $0x4a
  jmp alltraps
801076b9:	e9 30 f6 ff ff       	jmp    80106cee <alltraps>
...
801076be:	6a 00                	push   $0x0
  pushl $75
801076c0:	6a 4b                	push   $0x4b
  jmp alltraps
801076c2:	e9 27 f6 ff ff       	jmp    80106cee <alltraps>
...
801076c7:	6a 00                	push   $0x0
  pushl $76
801076c9:	6a 4c                	push   $0x4c
  jmp alltraps
801076cb:	e9 1e f6 ff ff       	jmp    80106cee <alltraps>
...
801076d0:	6a 00                	push   $0x0
  pushl $77
801076d2:	6a 4d                	push   $0x4d
  jmp alltraps
801076d4:	e9 15 f6 ff ff       	jmp    80106cee <alltraps>
...
801076d9:	6a 00                	push   $0x0
  pushl $78
801076db:	6a 4e                	push   $0x4e
  jmp alltraps
801076dd:	e9 0c f6 ff ff       	jmp    80106cee <alltraps>
...
801076e2:	6a 00                	push   $0x0
  pushl $79
801076e4:	6a 4f                	push   $0x4f
  jmp alltraps
801076e6:	e9 03 f6 ff ff       	jmp    80106cee <alltraps>
...
801076eb:	6a 00                	push   $0x0
  pushl $80
801076ed:	6a 50                	push   $0x50
  jmp alltraps
801076ef:	e9 fa f5 ff ff       	jmp    80106cee <alltraps>
...
801076f4:	6a 00                	push   $0x0
  pushl $81
801076f6:	6a 51                	push   $0x51
  jmp alltraps
801076f8:	e9 f1 f5 ff ff       	jmp    80106cee <alltraps>
...
801076fd:	6a 00                	push   $0x0
  pushl $82
801076ff:	6a 52                	push   $0x52
  jmp alltraps
80107701:	e9 e8 f5 ff ff       	jmp    80106cee <alltraps>
...
80107706:	6a 00                	push   $0x0
  pushl $83
80107708:	6a 53                	push   $0x53
  jmp alltraps
8010770a:	e9 df f5 ff ff       	jmp    80106cee <alltraps>
...
8010770f:	6a 00                	push   $0x0
  pushl $84
80107711:	6a 54                	push   $0x54
  jmp alltraps
80107713:	e9 d6 f5 ff ff       	jmp    80106cee <alltraps>
...
80107718:	6a 00                	push   $0x0
  pushl $85
8010771a:	6a 55                	push   $0x55
  jmp alltraps
8010771c:	e9 cd f5 ff ff       	jmp    80106cee <alltraps>
...
80107721:	6a 00                	push   $0x0
  pushl $86
80107723:	6a 56                	push   $0x56
  jmp alltraps
80107725:	e9 c4 f5 ff ff       	jmp    80106cee <alltraps>
...
8010772a:	6a 00                	push   $0x0
  pushl $87
8010772c:	6a 57                	push   $0x57
  jmp alltraps
8010772e:	e9 bb f5 ff ff       	jmp    80106cee <alltraps>
...
80107733:	6a 00                	push   $0x0
  pushl $88
80107735:	6a 58                	push   $0x58
  jmp alltraps
80107737:	e9 b2 f5 ff ff       	jmp    80106cee <alltraps>
...
8010773c:	6a 00                	push   $0x0
  pushl $89
8010773e:	6a 59                	push   $0x59
  jmp alltraps
80107740:	e9 a9 f5 ff ff       	jmp    80106cee <alltraps>
...
80107745:	6a 00                	push   $0x0
  pushl $90
80107747:	6a 5a                	push   $0x5a
  jmp alltraps
80107749:	e9 a0 f5 ff ff       	jmp    80106cee <alltraps>
...
8010774e:	6a 00                	push   $0x0
  pushl $91
80107750:	6a 5b                	push   $0x5b
  jmp alltraps
80107752:	e9 97 f5 ff ff       	jmp    80106cee <alltraps>
...
80107757:	6a 00                	push   $0x0
  pushl $92
80107759:	6a 5c                	push   $0x5c
  jmp alltraps
8010775b:	e9 8e f5 ff ff       	jmp    80106cee <alltraps>
...
80107760:	6a 00                	push   $0x0
  pushl $93
80107762:	6a 5d                	push   $0x5d
  jmp alltraps
80107764:	e9 85 f5 ff ff       	jmp    80106cee <alltraps>
...
80107769:	6a 00                	push   $0x0
  pushl $94
8010776b:	6a 5e                	push   $0x5e
  jmp alltraps
8010776d:	e9 7c f5 ff ff       	jmp    80106cee <alltraps>
...
80107772:	6a 00                	push   $0x0
  pushl $95
80107774:	6a 5f                	push   $0x5f
  jmp alltraps
80107776:	e9 73 f5 ff ff       	jmp    80106cee <alltraps>
...
8010777b:	6a 00                	push   $0x0
  pushl $96
8010777d:	6a 60                	push   $0x60
  jmp alltraps
8010777f:	e9 6a f5 ff ff       	jmp    80106cee <alltraps>
...
80107784:	6a 00                	push   $0x0
  pushl $97
80107786:	6a 61                	push   $0x61
  jmp alltraps
80107788:	e9 61 f5 ff ff       	jmp    80106cee <alltraps>
...
8010778d:	6a 00                	push   $0x0
  pushl $98
8010778f:	6a 62                	push   $0x62
  jmp alltraps
80107791:	e9 58 f5 ff ff       	jmp    80106cee <alltraps>
...
80107796:	6a 00                	push   $0x0
  pushl $99
80107798:	6a 63                	push   $0x63
  jmp alltraps
8010779a:	e9 4f f5 ff ff       	jmp    80106cee <alltraps>
...
8010779f:	6a 00                	push   $0x0
  pushl $100
801077a1:	6a 64                	push   $0x64
  jmp alltraps
801077a3:	e9 46 f5 ff ff       	jmp    80106cee <alltraps>
...
801077a8:	6a 00                	push   $0x0
  pushl $101
801077aa:	6a 65                	push   $0x65
  jmp alltraps
801077ac:	e9 3d f5 ff ff       	jmp    80106cee <alltraps>
...
801077b1:	6a 00                	push   $0x0
  pushl $102
801077b3:	6a 66                	push   $0x66
  jmp alltraps
801077b5:	e9 34 f5 ff ff       	jmp    80106cee <alltraps>
...
801077ba:	6a 00                	push   $0x0
  pushl $103
801077bc:	6a 67                	push   $0x67
  jmp alltraps
801077be:	e9 2b f5 ff ff       	jmp    80106cee <alltraps>
...
801077c3:	6a 00                	push   $0x0
  pushl $104
801077c5:	6a 68                	push   $0x68
  jmp alltraps
801077c7:	e9 22 f5 ff ff       	jmp    80106cee <alltraps>
...
801077cc:	6a 00                	push   $0x0
  pushl $105
801077ce:	6a 69                	push   $0x69
  jmp alltraps
801077d0:	e9 19 f5 ff ff       	jmp    80106cee <alltraps>
...
801077d5:	6a 00                	push   $0x0
  pushl $106
801077d7:	6a 6a                	push   $0x6a
  jmp alltraps
801077d9:	e9 10 f5 ff ff       	jmp    80106cee <alltraps>
...
801077de:	6a 00                	push   $0x0
  pushl $107
801077e0:	6a 6b                	push   $0x6b
  jmp alltraps
801077e2:	e9 07 f5 ff ff       	jmp    80106cee <alltraps>
...
801077e7:	6a 00                	push   $0x0
  pushl $108
801077e9:	6a 6c                	push   $0x6c
  jmp alltraps
801077eb:	e9 fe f4 ff ff       	jmp    80106cee <alltraps>
...
801077f0:	6a 00                	push   $0x0
  pushl $109
801077f2:	6a 6d                	push   $0x6d
  jmp alltraps
801077f4:	e9 f5 f4 ff ff       	jmp    80106cee <alltraps>
...
801077f9:	6a 00                	push   $0x0
  pushl $110
801077fb:	6a 6e                	push   $0x6e
  jmp alltraps
801077fd:	e9 ec f4 ff ff       	jmp    80106cee <alltraps>
...
80107802:	6a 00                	push   $0x0
  pushl $111
80107804:	6a 6f                	push   $0x6f
  jmp alltraps
80107806:	e9 e3 f4 ff ff       	jmp    80106cee <alltraps>
...
8010780b:	6a 00                	push   $0x0
  pushl $112
8010780d:	6a 70                	push   $0x70
  jmp alltraps
8010780f:	e9 da f4 ff ff       	jmp    80106cee <alltraps>
...
80107814:	6a 00                	push   $0x0
  pushl $113
80107816:	6a 71                	push   $0x71
  jmp alltraps
80107818:	e9 d1 f4 ff ff       	jmp    80106cee <alltraps>
...
8010781d:	6a 00                	push   $0x0
  pushl $114
8010781f:	6a 72                	push   $0x72
  jmp alltraps
80107821:	e9 c8 f4 ff ff       	jmp    80106cee <alltraps>
...
80107826:	6a 00                	push   $0x0
  pushl $115
80107828:	6a 73                	push   $0x73
  jmp alltraps
8010782a:	e9 bf f4 ff ff       	jmp    80106cee <alltraps>
...
8010782f:	6a 00                	push   $0x0
  pushl $116
80107831:	6a 74                	push   $0x74
  jmp alltraps
80107833:	e9 b6 f4 ff ff       	jmp    80106cee <alltraps>
...
80107838:	6a 00                	push   $0x0
  pushl $117
8010783a:	6a 75                	push   $0x75
  jmp alltraps
8010783c:	e9 ad f4 ff ff       	jmp    80106cee <alltraps>
...
80107841:	6a 00                	push   $0x0
  pushl $118
80107843:	6a 76                	push   $0x76
  jmp alltraps
80107845:	e9 a4 f4 ff ff       	jmp    80106cee <alltraps>
...
8010784a:	6a 00                	push   $0x0
  pushl $119
8010784c:	6a 77                	push   $0x77
  jmp alltraps
8010784e:	e9 9b f4 ff ff       	jmp    80106cee <alltraps>
...
80107853:	6a 00                	push   $0x0
  pushl $120
80107855:	6a 78                	push   $0x78
  jmp alltraps
80107857:	e9 92 f4 ff ff       	jmp    80106cee <alltraps>
...
8010785c:	6a 00                	push   $0x0
  pushl $121
8010785e:	6a 79                	push   $0x79
  jmp alltraps
80107860:	e9 89 f4 ff ff       	jmp    80106cee <alltraps>
...
80107865:	6a 00                	push   $0x0
  pushl $122
80107867:	6a 7a                	push   $0x7a
  jmp alltraps
80107869:	e9 80 f4 ff ff       	jmp    80106cee <alltraps>
...
8010786e:	6a 00                	push   $0x0
  pushl $123
80107870:	6a 7b                	push   $0x7b
  jmp alltraps
80107872:	e9 77 f4 ff ff       	jmp    80106cee <alltraps>
...
80107877:	6a 00                	push   $0x0
  pushl $124
80107879:	6a 7c                	push   $0x7c
  jmp alltraps
8010787b:	e9 6e f4 ff ff       	jmp    80106cee <alltraps>
...
80107880:	6a 00                	push   $0x0
  pushl $125
80107882:	6a 7d                	push   $0x7d
  jmp alltraps
80107884:	e9 65 f4 ff ff       	jmp    80106cee <alltraps>
...
80107889:	6a 00                	push   $0x0
  pushl $126
8010788b:	6a 7e                	push   $0x7e
  jmp alltraps
8010788d:	e9 5c f4 ff ff       	jmp    80106cee <alltraps>
...
80107892:	6a 00                	push   $0x0
  pushl $127
80107894:	6a 7f                	push   $0x7f
  jmp alltraps
80107896:	e9 53 f4 ff ff       	jmp    80106cee <alltraps>
...
8010789b:	6a 00                	push   $0x0
  pushl $128
8010789d:	68 80 00 00 00       	push   $0x80
  jmp alltraps
801078a2:	e9 47 f4 ff ff       	jmp    80106cee <alltraps>
...
801078a7:	6a 00                	push   $0x0
  pushl $129
801078a9:	68 81 00 00 00       	push   $0x81
  jmp alltraps
801078ae:	e9 3b f4 ff ff       	jmp    80106cee <alltraps>
...
801078b3:	6a 00                	push   $0x0
  pushl $130
801078b5:	68 82 00 00 00       	push   $0x82
  jmp alltraps
801078ba:	e9 2f f4 ff ff       	jmp    80106cee <alltraps>
...
801078bf:	6a 00                	push   $0x0
  pushl $131
801078c1:	68 83 00 00 00       	push   $0x83
  jmp alltraps
801078c6:	e9 23 f4 ff ff       	jmp    80106cee <alltraps>
...
801078cb:	6a 00                	push   $0x0
  pushl $132
801078cd:	68 84 00 00 00       	push   $0x84
  jmp alltraps
801078d2:	e9 17 f4 ff ff       	jmp    80106cee <alltraps>
...
801078d7:	6a 00                	push   $0x0
  pushl $133
801078d9:	68 85 00 00 00       	push   $0x85
  jmp alltraps
801078de:	e9 0b f4 ff ff       	jmp    80106cee <alltraps>
...
801078e3:	6a 00                	push   $0x0
  pushl $134
801078e5:	68 86 00 00 00       	push   $0x86
  jmp alltraps
801078ea:	e9 ff f3 ff ff       	jmp    80106cee <alltraps>
...
801078ef:	6a 00                	push   $0x0
  pushl $135
801078f1:	68 87 00 00 00       	push   $0x87
  jmp alltraps
801078f6:	e9 f3 f3 ff ff       	jmp    80106cee <alltraps>
...
801078fb:	6a 00                	push   $0x0
  pushl $136
801078fd:	68 88 00 00 00       	push   $0x88
  jmp alltraps
80107902:	e9 e7 f3 ff ff       	jmp    80106cee <alltraps>
...
80107907:	6a 00                	push   $0x0
  pushl $137
80107909:	68 89 00 00 00       	push   $0x89
  jmp alltraps
8010790e:	e9 db f3 ff ff       	jmp    80106cee <alltraps>
...
80107913:	6a 00                	push   $0x0
  pushl $138
80107915:	68 8a 00 00 00       	push   $0x8a
  jmp alltraps
8010791a:	e9 cf f3 ff ff       	jmp    80106cee <alltraps>
...
8010791f:	6a 00                	push   $0x0
  pushl $139
80107921:	68 8b 00 00 00       	push   $0x8b
  jmp alltraps
80107926:	e9 c3 f3 ff ff       	jmp    80106cee <alltraps>
...
8010792b:	6a 00                	push   $0x0
  pushl $140
8010792d:	68 8c 00 00 00       	push   $0x8c
  jmp alltraps
80107932:	e9 b7 f3 ff ff       	jmp    80106cee <alltraps>
...
80107937:	6a 00                	push   $0x0
  pushl $141
80107939:	68 8d 00 00 00       	push   $0x8d
  jmp alltraps
8010793e:	e9 ab f3 ff ff       	jmp    80106cee <alltraps>
...
80107943:	6a 00                	push   $0x0
  pushl $142
80107945:	68 8e 00 00 00       	push   $0x8e
  jmp alltraps
8010794a:	e9 9f f3 ff ff       	jmp    80106cee <alltraps>
...
8010794f:	6a 00                	push   $0x0
  pushl $143
80107951:	68 8f 00 00 00       	push   $0x8f
  jmp alltraps
80107956:	e9 93 f3 ff ff       	jmp    80106cee <alltraps>
...
8010795b:	6a 00                	push   $0x0
  pushl $144
8010795d:	68 90 00 00 00       	push   $0x90
  jmp alltraps
80107962:	e9 87 f3 ff ff       	jmp    80106cee <alltraps>
...
80107967:	6a 00                	push   $0x0
  pushl $145
80107969:	68 91 00 00 00       	push   $0x91
  jmp alltraps
8010796e:	e9 7b f3 ff ff       	jmp    80106cee <alltraps>
...
80107973:	6a 00                	push   $0x0
  pushl $146
80107975:	68 92 00 00 00       	push   $0x92
  jmp alltraps
8010797a:	e9 6f f3 ff ff       	jmp    80106cee <alltraps>
...
8010797f:	6a 00                	push   $0x0
  pushl $147
80107981:	68 93 00 00 00       	push   $0x93
  jmp alltraps
80107986:	e9 63 f3 ff ff       	jmp    80106cee <alltraps>
...
8010798b:	6a 00                	push   $0x0
  pushl $148
8010798d:	68 94 00 00 00       	push   $0x94
  jmp alltraps
80107992:	e9 57 f3 ff ff       	jmp    80106cee <alltraps>
...
80107997:	6a 00                	push   $0x0
  pushl $149
80107999:	68 95 00 00 00       	push   $0x95
  jmp alltraps
8010799e:	e9 4b f3 ff ff       	jmp    80106cee <alltraps>
...
801079a3:	6a 00                	push   $0x0
  pushl $150
801079a5:	68 96 00 00 00       	push   $0x96
  jmp alltraps
801079aa:	e9 3f f3 ff ff       	jmp    80106cee <alltraps>
...
801079af:	6a 00                	push   $0x0
  pushl $151
801079b1:	68 97 00 00 00       	push   $0x97
  jmp alltraps
801079b6:	e9 33 f3 ff ff       	jmp    80106cee <alltraps>
...
801079bb:	6a 00                	push   $0x0
  pushl $152
801079bd:	68 98 00 00 00       	push   $0x98
  jmp alltraps
801079c2:	e9 27 f3 ff ff       	jmp    80106cee <alltraps>
...
801079c7:	6a 00                	push   $0x0
  pushl $153
801079c9:	68 99 00 00 00       	push   $0x99
  jmp alltraps
801079ce:	e9 1b f3 ff ff       	jmp    80106cee <alltraps>
...
801079d3:	6a 00                	push   $0x0
  pushl $154
801079d5:	68 9a 00 00 00       	push   $0x9a
  jmp alltraps
801079da:	e9 0f f3 ff ff       	jmp    80106cee <alltraps>
...
801079df:	6a 00                	push   $0x0
  pushl $155
801079e1:	68 9b 00 00 00       	push   $0x9b
  jmp alltraps
801079e6:	e9 03 f3 ff ff       	jmp    80106cee <alltraps>
...
801079eb:	6a 00                	push   $0x0
  pushl $156
801079ed:	68 9c 00 00 00       	push   $0x9c
  jmp alltraps
801079f2:	e9 f7 f2 ff ff       	jmp    80106cee <alltraps>
...
801079f7:	6a 00                	push   $0x0
  pushl $157
801079f9:	68 9d 00 00 00       	push   $0x9d
  jmp alltraps
801079fe:	e9 eb f2 ff ff       	jmp    80106cee <alltraps>
...
80107a03:	6a 00                	push   $0x0
  pushl $158
80107a05:	68 9e 00 00 00       	push   $0x9e
  jmp alltraps
80107a0a:	e9 df f2 ff ff       	jmp    80106cee <alltraps>
...
80107a0f:	6a 00                	push   $0x0
  pushl $159
80107a11:	68 9f 00 00 00       	push   $0x9f
  jmp alltraps
80107a16:	e9 d3 f2 ff ff       	jmp    80106cee <alltraps>
...
80107a1b:	6a 00                	push   $0x0
  pushl $160
80107a1d:	68 a0 00 00 00       	push   $0xa0
  jmp alltraps
80107a22:	e9 c7 f2 ff ff       	jmp    80106cee <alltraps>
...
80107a27:	6a 00                	push   $0x0
  pushl $161
80107a29:	68 a1 00 00 00       	push   $0xa1
  jmp alltraps
80107a2e:	e9 bb f2 ff ff       	jmp    80106cee <alltraps>
...
80107a33:	6a 00                	push   $0x0
  pushl $162
80107a35:	68 a2 00 00 00       	push   $0xa2
  jmp alltraps
80107a3a:	e9 af f2 ff ff       	jmp    80106cee <alltraps>
...
80107a3f:	6a 00                	push   $0x0
  pushl $163
80107a41:	68 a3 00 00 00       	push   $0xa3
  jmp alltraps
80107a46:	e9 a3 f2 ff ff       	jmp    80106cee <alltraps>
...
80107a4b:	6a 00                	push   $0x0
  pushl $164
80107a4d:	68 a4 00 00 00       	push   $0xa4
  jmp alltraps
80107a52:	e9 97 f2 ff ff       	jmp    80106cee <alltraps>
...
80107a57:	6a 00                	push   $0x0
  pushl $165
80107a59:	68 a5 00 00 00       	push   $0xa5
  jmp alltraps
80107a5e:	e9 8b f2 ff ff       	jmp    80106cee <alltraps>
...
80107a63:	6a 00                	push   $0x0
  pushl $166
80107a65:	68 a6 00 00 00       	push   $0xa6
  jmp alltraps
80107a6a:	e9 7f f2 ff ff       	jmp    80106cee <alltraps>
...
80107a6f:	6a 00                	push   $0x0
  pushl $167
80107a71:	68 a7 00 00 00       	push   $0xa7
  jmp alltraps
80107a76:	e9 73 f2 ff ff       	jmp    80106cee <alltraps>
...
80107a7b:	6a 00                	push   $0x0
  pushl $168
80107a7d:	68 a8 00 00 00       	push   $0xa8
  jmp alltraps
80107a82:	e9 67 f2 ff ff       	jmp    80106cee <alltraps>
...
80107a87:	6a 00                	push   $0x0
  pushl $169
80107a89:	68 a9 00 00 00       	push   $0xa9
  jmp alltraps
80107a8e:	e9 5b f2 ff ff       	jmp    80106cee <alltraps>
...
80107a93:	6a 00                	push   $0x0
  pushl $170
80107a95:	68 aa 00 00 00       	push   $0xaa
  jmp alltraps
80107a9a:	e9 4f f2 ff ff       	jmp    80106cee <alltraps>
...
80107a9f:	6a 00                	push   $0x0
  pushl $171
80107aa1:	68 ab 00 00 00       	push   $0xab
  jmp alltraps
80107aa6:	e9 43 f2 ff ff       	jmp    80106cee <alltraps>
...
80107aab:	6a 00                	push   $0x0
  pushl $172
80107aad:	68 ac 00 00 00       	push   $0xac
  jmp alltraps
80107ab2:	e9 37 f2 ff ff       	jmp    80106cee <alltraps>
...
80107ab7:	6a 00                	push   $0x0
  pushl $173
80107ab9:	68 ad 00 00 00       	push   $0xad
  jmp alltraps
80107abe:	e9 2b f2 ff ff       	jmp    80106cee <alltraps>
...
80107ac3:	6a 00                	push   $0x0
  pushl $174
80107ac5:	68 ae 00 00 00       	push   $0xae
  jmp alltraps
80107aca:	e9 1f f2 ff ff       	jmp    80106cee <alltraps>
...
80107acf:	6a 00                	push   $0x0
  pushl $175
80107ad1:	68 af 00 00 00       	push   $0xaf
  jmp alltraps
80107ad6:	e9 13 f2 ff ff       	jmp    80106cee <alltraps>
...
80107adb:	6a 00                	push   $0x0
  pushl $176
80107add:	68 b0 00 00 00       	push   $0xb0
  jmp alltraps
80107ae2:	e9 07 f2 ff ff       	jmp    80106cee <alltraps>
...
80107ae7:	6a 00                	push   $0x0
  pushl $177
80107ae9:	68 b1 00 00 00       	push   $0xb1
  jmp alltraps
80107aee:	e9 fb f1 ff ff       	jmp    80106cee <alltraps>
...
80107af3:	6a 00                	push   $0x0
  pushl $178
80107af5:	68 b2 00 00 00       	push   $0xb2
  jmp alltraps
80107afa:	e9 ef f1 ff ff       	jmp    80106cee <alltraps>
...
80107aff:	6a 00                	push   $0x0
  pushl $179
80107b01:	68 b3 00 00 00       	push   $0xb3
  jmp alltraps
80107b06:	e9 e3 f1 ff ff       	jmp    80106cee <alltraps>
...
80107b0b:	6a 00                	push   $0x0
  pushl $180
80107b0d:	68 b4 00 00 00       	push   $0xb4
  jmp alltraps
80107b12:	e9 d7 f1 ff ff       	jmp    80106cee <alltraps>
...
80107b17:	6a 00                	push   $0x0
  pushl $181
80107b19:	68 b5 00 00 00       	push   $0xb5
  jmp alltraps
80107b1e:	e9 cb f1 ff ff       	jmp    80106cee <alltraps>
...
80107b23:	6a 00                	push   $0x0
  pushl $182
80107b25:	68 b6 00 00 00       	push   $0xb6
  jmp alltraps
80107b2a:	e9 bf f1 ff ff       	jmp    80106cee <alltraps>
...
80107b2f:	6a 00                	push   $0x0
  pushl $183
80107b31:	68 b7 00 00 00       	push   $0xb7
  jmp alltraps
80107b36:	e9 b3 f1 ff ff       	jmp    80106cee <alltraps>
...
80107b3b:	6a 00                	push   $0x0
  pushl $184
80107b3d:	68 b8 00 00 00       	push   $0xb8
  jmp alltraps
80107b42:	e9 a7 f1 ff ff       	jmp    80106cee <alltraps>
...
80107b47:	6a 00                	push   $0x0
  pushl $185
80107b49:	68 b9 00 00 00       	push   $0xb9
  jmp alltraps
80107b4e:	e9 9b f1 ff ff       	jmp    80106cee <alltraps>
...
80107b53:	6a 00                	push   $0x0
  pushl $186
80107b55:	68 ba 00 00 00       	push   $0xba
  jmp alltraps
80107b5a:	e9 8f f1 ff ff       	jmp    80106cee <alltraps>
...
80107b5f:	6a 00                	push   $0x0
  pushl $187
80107b61:	68 bb 00 00 00       	push   $0xbb
  jmp alltraps
80107b66:	e9 83 f1 ff ff       	jmp    80106cee <alltraps>
...
80107b6b:	6a 00                	push   $0x0
  pushl $188
80107b6d:	68 bc 00 00 00       	push   $0xbc
  jmp alltraps
80107b72:	e9 77 f1 ff ff       	jmp    80106cee <alltraps>
...
80107b77:	6a 00                	push   $0x0
  pushl $189
80107b79:	68 bd 00 00 00       	push   $0xbd
  jmp alltraps
80107b7e:	e9 6b f1 ff ff       	jmp    80106cee <alltraps>
...
80107b83:	6a 00                	push   $0x0
  pushl $190
80107b85:	68 be 00 00 00       	push   $0xbe
  jmp alltraps
80107b8a:	e9 5f f1 ff ff       	jmp    80106cee <alltraps>
...
80107b8f:	6a 00                	push   $0x0
  pushl $191
80107b91:	68 bf 00 00 00       	push   $0xbf
  jmp alltraps
80107b96:	e9 53 f1 ff ff       	jmp    80106cee <alltraps>
...
80107b9b:	6a 00                	push   $0x0
  pushl $192
80107b9d:	68 c0 00 00 00       	push   $0xc0
  jmp alltraps
80107ba2:	e9 47 f1 ff ff       	jmp    80106cee <alltraps>
...
80107ba7:	6a 00                	push   $0x0
  pushl $193
80107ba9:	68 c1 00 00 00       	push   $0xc1
  jmp alltraps
80107bae:	e9 3b f1 ff ff       	jmp    80106cee <alltraps>
...
80107bb3:	6a 00                	push   $0x0
  pushl $194
80107bb5:	68 c2 00 00 00       	push   $0xc2
  jmp alltraps
80107bba:	e9 2f f1 ff ff       	jmp    80106cee <alltraps>
...
80107bbf:	6a 00                	push   $0x0
  pushl $195
80107bc1:	68 c3 00 00 00       	push   $0xc3
  jmp alltraps
80107bc6:	e9 23 f1 ff ff       	jmp    80106cee <alltraps>
...
80107bcb:	6a 00                	push   $0x0
  pushl $196
80107bcd:	68 c4 00 00 00       	push   $0xc4
  jmp alltraps
80107bd2:	e9 17 f1 ff ff       	jmp    80106cee <alltraps>
...
80107bd7:	6a 00                	push   $0x0
  pushl $197
80107bd9:	68 c5 00 00 00       	push   $0xc5
  jmp alltraps
80107bde:	e9 0b f1 ff ff       	jmp    80106cee <alltraps>
...
80107be3:	6a 00                	push   $0x0
  pushl $198
80107be5:	68 c6 00 00 00       	push   $0xc6
  jmp alltraps
80107bea:	e9 ff f0 ff ff       	jmp    80106cee <alltraps>
...
80107bef:	6a 00                	push   $0x0
  pushl $199
80107bf1:	68 c7 00 00 00       	push   $0xc7
  jmp alltraps
80107bf6:	e9 f3 f0 ff ff       	jmp    80106cee <alltraps>
...
80107bfb:	6a 00                	push   $0x0
  pushl $200
80107bfd:	68 c8 00 00 00       	push   $0xc8
  jmp alltraps
80107c02:	e9 e7 f0 ff ff       	jmp    80106cee <alltraps>
...
80107c07:	6a 00                	push   $0x0
  pushl $201
80107c09:	68 c9 00 00 00       	push   $0xc9
  jmp alltraps
80107c0e:	e9 db f0 ff ff       	jmp    80106cee <alltraps>
...
80107c13:	6a 00                	push   $0x0
  pushl $202
80107c15:	68 ca 00 00 00       	push   $0xca
  jmp alltraps
80107c1a:	e9 cf f0 ff ff       	jmp    80106cee <alltraps>
...
80107c1f:	6a 00                	push   $0x0
  pushl $203
80107c21:	68 cb 00 00 00       	push   $0xcb
  jmp alltraps
80107c26:	e9 c3 f0 ff ff       	jmp    80106cee <alltraps>
...
80107c2b:	6a 00                	push   $0x0
  pushl $204
80107c2d:	68 cc 00 00 00       	push   $0xcc
  jmp alltraps
80107c32:	e9 b7 f0 ff ff       	jmp    80106cee <alltraps>
...
80107c37:	6a 00                	push   $0x0
  pushl $205
80107c39:	68 cd 00 00 00       	push   $0xcd
  jmp alltraps
80107c3e:	e9 ab f0 ff ff       	jmp    80106cee <alltraps>
...
80107c43:	6a 00                	push   $0x0
  pushl $206
80107c45:	68 ce 00 00 00       	push   $0xce
  jmp alltraps
80107c4a:	e9 9f f0 ff ff       	jmp    80106cee <alltraps>
...
80107c4f:	6a 00                	push   $0x0
  pushl $207
80107c51:	68 cf 00 00 00       	push   $0xcf
  jmp alltraps
80107c56:	e9 93 f0 ff ff       	jmp    80106cee <alltraps>
...
80107c5b:	6a 00                	push   $0x0
  pushl $208
80107c5d:	68 d0 00 00 00       	push   $0xd0
  jmp alltraps
80107c62:	e9 87 f0 ff ff       	jmp    80106cee <alltraps>
...
80107c67:	6a 00                	push   $0x0
  pushl $209
80107c69:	68 d1 00 00 00       	push   $0xd1
  jmp alltraps
80107c6e:	e9 7b f0 ff ff       	jmp    80106cee <alltraps>
...
80107c73:	6a 00                	push   $0x0
  pushl $210
80107c75:	68 d2 00 00 00       	push   $0xd2
  jmp alltraps
80107c7a:	e9 6f f0 ff ff       	jmp    80106cee <alltraps>
...
80107c7f:	6a 00                	push   $0x0
  pushl $211
80107c81:	68 d3 00 00 00       	push   $0xd3
  jmp alltraps
80107c86:	e9 63 f0 ff ff       	jmp    80106cee <alltraps>
...
80107c8b:	6a 00                	push   $0x0
  pushl $212
80107c8d:	68 d4 00 00 00       	push   $0xd4
  jmp alltraps
80107c92:	e9 57 f0 ff ff       	jmp    80106cee <alltraps>
...
80107c97:	6a 00                	push   $0x0
  pushl $213
80107c99:	68 d5 00 00 00       	push   $0xd5
  jmp alltraps
80107c9e:	e9 4b f0 ff ff       	jmp    80106cee <alltraps>
...
80107ca3:	6a 00                	push   $0x0
  pushl $214
80107ca5:	68 d6 00 00 00       	push   $0xd6
  jmp alltraps
80107caa:	e9 3f f0 ff ff       	jmp    80106cee <alltraps>
...
80107caf:	6a 00                	push   $0x0
  pushl $215
80107cb1:	68 d7 00 00 00       	push   $0xd7
  jmp alltraps
80107cb6:	e9 33 f0 ff ff       	jmp    80106cee <alltraps>
...
80107cbb:	6a 00                	push   $0x0
  pushl $216
80107cbd:	68 d8 00 00 00       	push   $0xd8
  jmp alltraps
80107cc2:	e9 27 f0 ff ff       	jmp    80106cee <alltraps>
...
80107cc7:	6a 00                	push   $0x0
  pushl $217
80107cc9:	68 d9 00 00 00       	push   $0xd9
  jmp alltraps
80107cce:	e9 1b f0 ff ff       	jmp    80106cee <alltraps>
...
80107cd3:	6a 00                	push   $0x0
  pushl $218
80107cd5:	68 da 00 00 00       	push   $0xda
  jmp alltraps
80107cda:	e9 0f f0 ff ff       	jmp    80106cee <alltraps>
...
80107cdf:	6a 00                	push   $0x0
  pushl $219
80107ce1:	68 db 00 00 00       	push   $0xdb
  jmp alltraps
80107ce6:	e9 03 f0 ff ff       	jmp    80106cee <alltraps>
...
80107ceb:	6a 00                	push   $0x0
  pushl $220
80107ced:	68 dc 00 00 00       	push   $0xdc
  jmp alltraps
80107cf2:	e9 f7 ef ff ff       	jmp    80106cee <alltraps>
...
80107cf7:	6a 00                	push   $0x0
  pushl $221
80107cf9:	68 dd 00 00 00       	push   $0xdd
  jmp alltraps
80107cfe:	e9 eb ef ff ff       	jmp    80106cee <alltraps>
...
80107d03:	6a 00                	push   $0x0
  pushl $222
80107d05:	68 de 00 00 00       	push   $0xde
  jmp alltraps
80107d0a:	e9 df ef ff ff       	jmp    80106cee <alltraps>
...
80107d0f:	6a 00                	push   $0x0
  pushl $223
80107d11:	68 df 00 00 00       	push   $0xdf
  jmp alltraps
80107d16:	e9 d3 ef ff ff       	jmp    80106cee <alltraps>
...
80107d1b:	6a 00                	push   $0x0
  pushl $224
80107d1d:	68 e0 00 00 00       	push   $0xe0
  jmp alltraps
80107d22:	e9 c7 ef ff ff       	jmp    80106cee <alltraps>
...
80107d27:	6a 00                	push   $0x0
  pushl $225
80107d29:	68 e1 00 00 00       	push   $0xe1
  jmp alltraps
80107d2e:	e9 bb ef ff ff       	jmp    80106cee <alltraps>
...
80107d33:	6a 00                	push   $0x0
  pushl $226
80107d35:	68 e2 00 00 00       	push   $0xe2
  jmp alltraps
80107d3a:	e9 af ef ff ff       	jmp    80106cee <alltraps>
...
80107d3f:	6a 00                	push   $0x0
  pushl $227
80107d41:	68 e3 00 00 00       	push   $0xe3
  jmp alltraps
80107d46:	e9 a3 ef ff ff       	jmp    80106cee <alltraps>
...
80107d4b:	6a 00                	push   $0x0
  pushl $228
80107d4d:	68 e4 00 00 00       	push   $0xe4
  jmp alltraps
80107d52:	e9 97 ef ff ff       	jmp    80106cee <alltraps>
...
80107d57:	6a 00                	push   $0x0
  pushl $229
80107d59:	68 e5 00 00 00       	push   $0xe5
  jmp alltraps
80107d5e:	e9 8b ef ff ff       	jmp    80106cee <alltraps>
...
80107d63:	6a 00                	push   $0x0
  pushl $230
80107d65:	68 e6 00 00 00       	push   $0xe6
  jmp alltraps
80107d6a:	e9 7f ef ff ff       	jmp    80106cee <alltraps>
...
80107d6f:	6a 00                	push   $0x0
  pushl $231
80107d71:	68 e7 00 00 00       	push   $0xe7
  jmp alltraps
80107d76:	e9 73 ef ff ff       	jmp    80106cee <alltraps>
...
80107d7b:	6a 00                	push   $0x0
  pushl $232
80107d7d:	68 e8 00 00 00       	push   $0xe8
  jmp alltraps
80107d82:	e9 67 ef ff ff       	jmp    80106cee <alltraps>
...
80107d87:	6a 00                	push   $0x0
  pushl $233
80107d89:	68 e9 00 00 00       	push   $0xe9
  jmp alltraps
80107d8e:	e9 5b ef ff ff       	jmp    80106cee <alltraps>
...
80107d93:	6a 00                	push   $0x0
  pushl $234
80107d95:	68 ea 00 00 00       	push   $0xea
  jmp alltraps
80107d9a:	e9 4f ef ff ff       	jmp    80106cee <alltraps>
...
80107d9f:	6a 00                	push   $0x0
  pushl $235
80107da1:	68 eb 00 00 00       	push   $0xeb
  jmp alltraps
80107da6:	e9 43 ef ff ff       	jmp    80106cee <alltraps>
...
80107dab:	6a 00                	push   $0x0
  pushl $236
80107dad:	68 ec 00 00 00       	push   $0xec
  jmp alltraps
80107db2:	e9 37 ef ff ff       	jmp    80106cee <alltraps>
...
80107db7:	6a 00                	push   $0x0
  pushl $237
80107db9:	68 ed 00 00 00       	push   $0xed
  jmp alltraps
80107dbe:	e9 2b ef ff ff       	jmp    80106cee <alltraps>
...
80107dc3:	6a 00                	push   $0x0
  pushl $238
80107dc5:	68 ee 00 00 00       	push   $0xee
  jmp alltraps
80107dca:	e9 1f ef ff ff       	jmp    80106cee <alltraps>
...
80107dcf:	6a 00                	push   $0x0
  pushl $239
80107dd1:	68 ef 00 00 00       	push   $0xef
  jmp alltraps
80107dd6:	e9 13 ef ff ff       	jmp    80106cee <alltraps>
...
80107ddb:	6a 00                	push   $0x0
  pushl $240
80107ddd:	68 f0 00 00 00       	push   $0xf0
  jmp alltraps
80107de2:	e9 07 ef ff ff       	jmp    80106cee <alltraps>
...
80107de7:	6a 00                	push   $0x0
  pushl $241
80107de9:	68 f1 00 00 00       	push   $0xf1
  jmp alltraps
80107dee:	e9 fb ee ff ff       	jmp    80106cee <alltraps>
...
80107df3:	6a 00                	push   $0x0
  pushl $242
80107df5:	68 f2 00 00 00       	push   $0xf2
  jmp alltraps
80107dfa:	e9 ef ee ff ff       	jmp    80106cee <alltraps>
...
80107dff:	6a 00                	push   $0x0
  pushl $243
80107e01:	68 f3 00 00 00       	push   $0xf3
  jmp alltraps
80107e06:	e9 e3 ee ff ff       	jmp    80106cee <alltraps>
...
80107e0b:	6a 00                	push   $0x0
  pushl $244
80107e0d:	68 f4 00 00 00       	push   $0xf4
  jmp alltraps
80107e12:	e9 d7 ee ff ff       	jmp    80106cee <alltraps>
...
80107e17:	6a 00                	push   $0x0
  pushl $245
80107e19:	68 f5 00 00 00       	push   $0xf5
  jmp alltraps
80107e1e:	e9 cb ee ff ff       	jmp    80106cee <alltraps>
...
80107e23:	6a 00                	push   $0x0
  pushl $246
80107e25:	68 f6 00 00 00       	push   $0xf6
  jmp alltraps
80107e2a:	e9 bf ee ff ff       	jmp    80106cee <alltraps>
...
80107e2f:	6a 00                	push   $0x0
  pushl $247
80107e31:	68 f7 00 00 00       	push   $0xf7
  jmp alltraps
80107e36:	e9 b3 ee ff ff       	jmp    80106cee <alltraps>
...
80107e3b:	6a 00                	push   $0x0
  pushl $248
80107e3d:	68 f8 00 00 00       	push   $0xf8
  jmp alltraps
80107e42:	e9 a7 ee ff ff       	jmp    80106cee <alltraps>
...
80107e47:	6a 00                	push   $0x0
  pushl $249
80107e49:	68 f9 00 00 00       	push   $0xf9
  jmp alltraps
80107e4e:	e9 9b ee ff ff       	jmp    80106cee <alltraps>
...
80107e53:	6a 00                	push   $0x0
  pushl $250
80107e55:	68 fa 00 00 00       	push   $0xfa
  jmp alltraps
80107e5a:	e9 8f ee ff ff       	jmp    80106cee <alltraps>
...
80107e5f:	6a 00                	push   $0x0
  pushl $251
80107e61:	68 fb 00 00 00       	push   $0xfb
  jmp alltraps
80107e66:	e9 83 ee ff ff       	jmp    80106cee <alltraps>
...
80107e6b:	6a 00                	push   $0x0
  pushl $252
80107e6d:	68 fc 00 00 00       	push   $0xfc
  jmp alltraps
80107e72:	e9 77 ee ff ff       	jmp    80106cee <alltraps>
...
80107e77:	6a 00                	push   $0x0
  pushl $253
80107e79:	68 fd 00 00 00       	push   $0xfd
  jmp alltraps
80107e7e:	e9 6b ee ff ff       	jmp    80106cee <alltraps>
...
80107e83:	6a 00                	push   $0x0
  pushl $254
80107e85:	68 fe 00 00 00       	push   $0xfe
  jmp alltraps
80107e8a:	e9 5f ee ff ff       	jmp    80106cee <alltraps>
...
80107e8f:	6a 00                	push   $0x0
  pushl $255
80107e91:	68 ff 00 00 00       	push   $0xff
  jmp alltraps
80107e96:	e9 53 ee ff ff       	jmp    80106cee <alltraps>
...
80107ea4:	83 e8 01             	sub    $0x1,%eax
80107ea7:	66 89 45 fa          	mov    %ax,-0x6(%ebp)
  pd[1] = (uint)p;
80107eab:	8b 45 08             	mov    0x8(%ebp),%eax
80107eae:	66 89 45 fc          	mov    %ax,-0x4(%ebp)
  pd[2] = (uint)p >> 16;
80107eb2:	8b 45 08             	mov    0x8(%ebp),%eax
80107eb5:	c1 e8 10             	shr    $0x10,%eax
80107eb8:	66 89 45 fe          	mov    %ax,-0x2(%ebp)

  asm volatile("lgdt (%0)" : : "r" (pd));
80107ebc:	8d 45 fa             	lea    -0x6(%ebp),%eax
80107ebf:	0f 01 10             	lgdtl  (%eax)
}
80107ec2:	c9                   	leave  
80107ec3:	c3                   	ret    
...
80107ec7:	83 ec 04             	sub    $0x4,%esp
80107eca:	8b 45 08             	mov    0x8(%ebp),%eax
80107ecd:	66 89 45 fc          	mov    %ax,-0x4(%ebp)
  asm volatile("ltr %0" : : "r" (sel));
80107ed1:	0f b7 45 fc          	movzwl -0x4(%ebp),%eax
80107ed5:	0f 00 d8             	ltr    %ax
}
80107ed8:	c9                   	leave  
80107ed9:	c3                   	ret    
...
80107ee3:	66 89 45 fc          	mov    %ax,-0x4(%ebp)
  asm volatile("movw %0, %%gs" : : "r" (v));
80107ee7:	0f b7 45 fc          	movzwl -0x4(%ebp),%eax
80107eeb:	8e e8                	mov    %eax,%gs
}
80107eed:	c9                   	leave  
80107eee:	c3                   	ret    
...
80107f18:	83 ec 14             	sub    $0x14,%esp
  ...
  c = &cpus[cpunum()];
80107f1b:	e8 c2 af ff ff       	call   80102ee2 <cpunum>
80107f20:	69 c0 bc 00 00 00    	imul   $0xbc,%eax,%eax
80107f26:	05 40 34 11 80       	add    $0x80113440,%eax
80107f2b:	89 45 f4             	mov    %eax,-0xc(%ebp)
  c->gdt[SEG_KCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, 0);
80107f2e:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107f31:	66 c7 40 78 ff ff    	movw   $0xffff,0x78(%eax)
80107f37:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107f3a:	66 c7 40 7a 00 00    	movw   $0x0,0x7a(%eax)
80107f40:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107f43:	c6 40 7c 00          	movb   $0x0,0x7c(%eax)
80107f47:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107f4a:	0f b6 50 7d          	movzbl 0x7d(%eax),%edx
80107f4e:	83 e2 f0             	and    $0xfffffff0,%edx
80107f51:	83 ca 0a             	or     $0xa,%edx
80107f54:	88 50 7d             	mov    %dl,0x7d(%eax)
80107f57:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107f5a:	0f b6 50 7d          	movzbl 0x7d(%eax),%edx
80107f5e:	83 ca 10             	or     $0x10,%edx
80107f61:	88 50 7d             	mov    %dl,0x7d(%eax)
80107f64:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107f67:	0f b6 50 7d          	movzbl 0x7d(%eax),%edx
80107f6b:	83 e2 9f             	and    $0xffffff9f,%edx
80107f6e:	88 50 7d             	mov    %dl,0x7d(%eax)
80107f71:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107f74:	0f b6 50 7d          	movzbl 0x7d(%eax),%edx
80107f78:	83 ca 80             	or     $0xffffff80,%edx
80107f7b:	88 50 7d             	mov    %dl,0x7d(%eax)
80107f7e:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107f81:	0f b6 50 7e          	movzbl 0x7e(%eax),%edx
80107f85:	83 ca 0f             	or     $0xf,%edx
80107f88:	88 50 7e             	mov    %dl,0x7e(%eax)
80107f8b:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107f8e:	0f b6 50 7e          	movzbl 0x7e(%eax),%edx
80107f92:	83 e2 ef             	and    $0xffffffef,%edx
80107f95:	88 50 7e             	mov    %dl,0x7e(%eax)
80107f98:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107f9b:	0f b6 50 7e          	movzbl 0x7e(%eax),%edx
80107f9f:	83 e2 df             	and    $0xffffffdf,%edx
80107fa2:	88 50 7e             	mov    %dl,0x7e(%eax)
80107fa5:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107fa8:	0f b6 50 7e          	movzbl 0x7e(%eax),%edx
80107fac:	83 ca 40             	or     $0x40,%edx
80107faf:	88 50 7e             	mov    %dl,0x7e(%eax)
80107fb2:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107fb5:	0f b6 50 7e          	movzbl 0x7e(%eax),%edx
80107fb9:	83 ca 80             	or     $0xffffff80,%edx
80107fbc:	88 50 7e             	mov    %dl,0x7e(%eax)
80107fbf:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107fc2:	c6 40 7f 00          	movb   $0x0,0x7f(%eax)
  c->gdt[SEG_KDATA] = SEG(STA_W, 0, 0xffffffff, 0);
80107fc6:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107fc9:	66 c7 80 80 00 00 00 	movw   $0xffff,0x80(%eax)
80107fd0:	ff ff 
80107fd2:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107fd5:	66 c7 80 82 00 00 00 	movw   $0x0,0x82(%eax)
80107fdc:	00 00 
80107fde:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107fe1:	c6 80 84 00 00 00 00 	movb   $0x0,0x84(%eax)
80107fe8:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107feb:	0f b6 90 85 00 00 00 	movzbl 0x85(%eax),%edx
80107ff2:	83 e2 f0             	and    $0xfffffff0,%edx
80107ff5:	83 ca 02             	or     $0x2,%edx
...
8010801b:	83 e2 9f             	and    $0xffffff9f,%edx
8010801e:	88 90 85 00 00 00    	mov    %dl,0x85(%eax)
80108024:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108027:	0f b6 90 85 00 00 00 	movzbl 0x85(%eax),%edx
8010802e:	83 ca 80             	or     $0xffffff80,%edx
80108031:	88 90 85 00 00 00    	mov    %dl,0x85(%eax)
...
80108067:	83 e2 df             	and    $0xffffffdf,%edx
...
8010807a:	83 ca 40             	or     $0x40,%edx
8010807d:	88 90 86 00 00 00    	mov    %dl,0x86(%eax)
80108083:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108086:	0f b6 90 86 00 00 00 	movzbl 0x86(%eax),%edx
8010808d:	83 ca 80             	or     $0xffffff80,%edx
80108090:	88 90 86 00 00 00    	mov    %dl,0x86(%eax)
80108096:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108099:	c6 80 87 00 00 00 00 	movb   $0x0,0x87(%eax)
  c->gdt[SEG_UCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, DPL_USER);
801080a0:	8b 45 f4             	mov    -0xc(%ebp),%eax
801080a3:	66 c7 80 90 00 00 00 	movw   $0xffff,0x90(%eax)
801080aa:	ff ff 
801080ac:	8b 45 f4             	mov    -0xc(%ebp),%eax
801080af:	66 c7 80 92 00 00 00 	movw   $0x0,0x92(%eax)
801080b6:	00 00 
801080b8:	8b 45 f4             	mov    -0xc(%ebp),%eax
801080bb:	c6 80 94 00 00 00 00 	movb   $0x0,0x94(%eax)
801080c2:	8b 45 f4             	mov    -0xc(%ebp),%eax
801080c5:	0f b6 90 95 00 00 00 	movzbl 0x95(%eax),%edx
801080cc:	83 e2 f0             	and    $0xfffffff0,%edx
801080cf:	83 ca 0a             	or     $0xa,%edx
...
801080f5:	83 ca 60             	or     $0x60,%edx
801080f8:	88 90 95 00 00 00    	mov    %dl,0x95(%eax)
801080fe:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108101:	0f b6 90 95 00 00 00 	movzbl 0x95(%eax),%edx
80108108:	83 ca 80             	or     $0xffffff80,%edx
8010810b:	88 90 95 00 00 00    	mov    %dl,0x95(%eax)
...
80108160:	0f b6 90 96 00 00 00 	movzbl 0x96(%eax),%edx
80108167:	83 ca 80             	or     $0xffffff80,%edx
8010816a:	88 90 96 00 00 00    	mov    %dl,0x96(%eax)
80108170:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108173:	c6 80 97 00 00 00 00 	movb   $0x0,0x97(%eax)
  c->gdt[SEG_UDATA] = SEG(STA_W, 0, 0xffffffff, DPL_USER);
8010817a:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010817d:	66 c7 80 98 00 00 00 	movw   $0xffff,0x98(%eax)
80108184:	ff ff 
80108186:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108189:	66 c7 80 9a 00 00 00 	movw   $0x0,0x9a(%eax)
80108190:	00 00 
80108192:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108195:	c6 80 9c 00 00 00 00 	movb   $0x0,0x9c(%eax)
8010819c:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010819f:	0f b6 90 9d 00 00 00 	movzbl 0x9d(%eax),%edx
801081a6:	83 e2 f0             	and    $0xfffffff0,%edx
801081a9:	83 ca 02             	or     $0x2,%edx
...
801081db:	0f b6 90 9d 00 00 00 	movzbl 0x9d(%eax),%edx
801081e2:	83 ca 80             	or     $0xffffff80,%edx
801081e5:	88 90 9d 00 00 00    	mov    %dl,0x9d(%eax)
...
8010823a:	0f b6 90 9e 00 00 00 	movzbl 0x9e(%eax),%edx
80108241:	83 ca 80             	or     $0xffffff80,%edx
80108244:	88 90 9e 00 00 00    	mov    %dl,0x9e(%eax)
8010824a:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010824d:	c6 80 9f 00 00 00 00 	movb   $0x0,0x9f(%eax)

  // Map cpu, and curproc
  c->gdt[SEG_KCPU] = SEG(STA_W, &c->cpu, 8, 0);
80108254:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108257:	05 b4 00 00 00       	add    $0xb4,%eax
8010825c:	89 c3                	mov    %eax,%ebx
8010825e:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108261:	05 b4 00 00 00       	add    $0xb4,%eax
...
8010827b:	66 c7 80 88 00 00 00 	movw   $0x0,0x88(%eax)
80108282:	00 00 
80108284:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108287:	66 89 98 8a 00 00 00 	mov    %bx,0x8a(%eax)
8010828e:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108291:	88 90 8c 00 00 00    	mov    %dl,0x8c(%eax)
80108297:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010829a:	0f b6 90 8d 00 00 00 	movzbl 0x8d(%eax),%edx
801082a1:	83 e2 f0             	and    $0xfffffff0,%edx
801082a4:	83 ca 02             	or     $0x2,%edx
801082a7:	88 90 8d 00 00 00    	mov    %dl,0x8d(%eax)
801082ad:	8b 45 f4             	mov    -0xc(%ebp),%eax
801082b0:	0f b6 90 8d 00 00 00 	movzbl 0x8d(%eax),%edx
801082b7:	83 ca 10             	or     $0x10,%edx
801082ba:	88 90 8d 00 00 00    	mov    %dl,0x8d(%eax)
801082c0:	8b 45 f4             	mov    -0xc(%ebp),%eax
801082c3:	0f b6 90 8d 00 00 00 	movzbl 0x8d(%eax),%edx
801082ca:	83 e2 9f             	and    $0xffffff9f,%edx
801082cd:	88 90 8d 00 00 00    	mov    %dl,0x8d(%eax)
801082d3:	8b 45 f4             	mov    -0xc(%ebp),%eax
801082d6:	0f b6 90 8d 00 00 00 	movzbl 0x8d(%eax),%edx
801082dd:	83 ca 80             	or     $0xffffff80,%edx
801082e0:	88 90 8d 00 00 00    	mov    %dl,0x8d(%eax)
801082e6:	8b 45 f4             	mov    -0xc(%ebp),%eax
801082e9:	0f b6 90 8e 00 00 00 	movzbl 0x8e(%eax),%edx
801082f0:	83 e2 f0             	and    $0xfffffff0,%edx
801082f3:	88 90 8e 00 00 00    	mov    %dl,0x8e(%eax)
801082f9:	8b 45 f4             	mov    -0xc(%ebp),%eax
801082fc:	0f b6 90 8e 00 00 00 	movzbl 0x8e(%eax),%edx
80108303:	83 e2 ef             	and    $0xffffffef,%edx
80108306:	88 90 8e 00 00 00    	mov    %dl,0x8e(%eax)
8010830c:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010830f:	0f b6 90 8e 00 00 00 	movzbl 0x8e(%eax),%edx
80108316:	83 e2 df             	and    $0xffffffdf,%edx
80108319:	88 90 8e 00 00 00    	mov    %dl,0x8e(%eax)
8010831f:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108322:	0f b6 90 8e 00 00 00 	movzbl 0x8e(%eax),%edx
80108329:	83 ca 40             	or     $0x40,%edx
8010832c:	88 90 8e 00 00 00    	mov    %dl,0x8e(%eax)
80108332:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108335:	0f b6 90 8e 00 00 00 	movzbl 0x8e(%eax),%edx
8010833c:	83 ca 80             	or     $0xffffff80,%edx
8010833f:	88 90 8e 00 00 00    	mov    %dl,0x8e(%eax)
80108345:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108348:	88 88 8f 00 00 00    	mov    %cl,0x8f(%eax)

  lgdt(c->gdt, sizeof(c->gdt));
8010834e:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108351:	83 c0 70             	add    $0x70,%eax
80108354:	83 ec 08             	sub    $0x8,%esp
80108357:	6a 38                	push   $0x38
80108359:	50                   	push   %eax
8010835a:	e8 3c fb ff ff       	call   80107e9b <lgdt>
8010835f:	83 c4 10             	add    $0x10,%esp
  loadgs(SEG_KCPU << 3);
80108362:	83 ec 0c             	sub    $0xc,%esp
80108365:	6a 18                	push   $0x18
80108367:	e8 6e fb ff ff       	call   80107eda <loadgs>
8010836c:	83 c4 10             	add    $0x10,%esp
  
  // Initialize cpu-local storage.
  cpu = c;
8010836f:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108372:	65 a3 00 00 00 00    	mov    %eax,%gs:0x0
  proc = 0;
80108378:	65 c7 05 04 00 00 00 	movl   $0x0,%gs:0x4
8010837f:	00 00 00 00 
}
...
801083ad:	74 18                	je     801083c7 <walkpgdir+0x3f>
...
801083ba:	e8 48 fb ff ff       	call   80107f07 <p2v>
801083bf:	83 c4 04             	add    $0x4,%esp
801083c2:	89 45 f4             	mov    %eax,-0xc(%ebp)
801083c5:	eb 48                	jmp    8010840f <walkpgdir+0x87>
  } else {
    if(!alloc || (pgtab = (pte_t*)kalloc()) == 0)
801083c7:	83 7d 10 00          	cmpl   $0x0,0x10(%ebp)
801083cb:	74 0e                	je     801083db <walkpgdir+0x53>
801083cd:	e8 af a7 ff ff       	call   80102b81 <kalloc>
801083d2:	89 45 f4             	mov    %eax,-0xc(%ebp)
801083d5:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
801083d9:	75 07                	jne    801083e2 <walkpgdir+0x5a>
      return 0;
801083db:	b8 00 00 00 00       	mov    $0x0,%eax
801083e0:	eb 44                	jmp    80108426 <walkpgdir+0x9e>
    // Make sure all those PTE_P bits are zero.
    memset(pgtab, 0, PGSIZE);
801083e2:	83 ec 04             	sub    $0x4,%esp
801083e5:	68 00 10 00 00       	push   $0x1000
801083ea:	6a 00                	push   $0x0
801083ec:	ff 75 f4             	pushl  -0xc(%ebp)
801083ef:	e8 2c d2 ff ff       	call   80105620 <memset>
...
801083fa:	ff 75 f4             	pushl  -0xc(%ebp)
801083fd:	e8 f8 fa ff ff       	call   80107efa <v2p>
80108402:	83 c4 10             	add    $0x10,%esp
80108405:	83 c8 07             	or     $0x7,%eax
80108408:	89 c2                	mov    %eax,%edx
8010840a:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010840d:	89 10                	mov    %edx,(%eax)
  }
  return &pgtab[PTX(va)];
8010840f:	8b 45 0c             	mov    0xc(%ebp),%eax
80108412:	c1 e8 0c             	shr    $0xc,%eax
80108415:	25 ff 03 00 00       	and    $0x3ff,%eax
...
8010843f:	01 d0                	add    %edx,%eax
80108441:	83 e8 01             	sub    $0x1,%eax
80108444:	25 00 f0 ff ff       	and    $0xfffff000,%eax
80108449:	89 45 f0             	mov    %eax,-0x10(%ebp)
  for(;;){
    if((pte = walkpgdir(pgdir, a, 1)) == 0)
8010844c:	83 ec 04             	sub    $0x4,%esp
8010844f:	6a 01                	push   $0x1
80108451:	ff 75 f4             	pushl  -0xc(%ebp)
80108454:	ff 75 08             	pushl  0x8(%ebp)
80108457:	e8 2c ff ff ff       	call   80108388 <walkpgdir>
8010845c:	83 c4 10             	add    $0x10,%esp
8010845f:	89 45 ec             	mov    %eax,-0x14(%ebp)
80108462:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
80108466:	75 07                	jne    8010846f <mappages+0x47>
      return -1;
80108468:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010846d:	eb 49                	jmp    801084b8 <mappages+0x90>
    if(*pte & PTE_P)
8010846f:	8b 45 ec             	mov    -0x14(%ebp),%eax
80108472:	8b 00                	mov    (%eax),%eax
80108474:	83 e0 01             	and    $0x1,%eax
80108477:	85 c0                	test   %eax,%eax
80108479:	74 0d                	je     80108488 <mappages+0x60>
      panic("remap");
8010847b:	83 ec 0c             	sub    $0xc,%esp
8010847e:	68 78 92 10 80       	push   $0x80109278
80108483:	e8 d4 80 ff ff       	call   8010055c <panic>
    *pte = pa | perm | PTE_P;
...
8010849e:	75 08                	jne    801084a8 <mappages+0x80>
      break;
801084a0:	90                   	nop
    a += PGSIZE;
    pa += PGSIZE;
...
801084a6:	eb 10                	jmp    801084b8 <mappages+0x90>
    if(*pte & PTE_P)
      panic("remap");
    *pte = pa | perm | PTE_P;
    if(a == last)
...
801084b6:	eb 94                	jmp    8010844c <mappages+0x24>
  return 0;
}
801084b8:	c9                   	leave  
801084b9:	c3                   	ret    
...
801084f6:	e8 0c fa ff ff       	call   80107f07 <p2v>
...
80108508:	68 7e 92 10 80       	push   $0x8010927e
...
80108544:	e8 df fe ff ff       	call   80108428 <mappages>
...
8010858c:	e8 69 f9 ff ff       	call   80107efa <v2p>
80108591:	83 c4 04             	add    $0x4,%esp
80108594:	50                   	push   %eax
80108595:	e8 55 f9 ff ff       	call   80107eef <lcr3>
...
801086c8:	e8 f7 f7 ff ff       	call   80107ec4 <ltr>
...
801086dd:	68 8f 92 10 80       	push   $0x8010928f
...
801086f1:	e8 04 f8 ff ff       	call   80107efa <v2p>
801086f6:	83 c4 10             	add    $0x10,%esp
801086f9:	83 ec 0c             	sub    $0xc,%esp
801086fc:	50                   	push   %eax
801086fd:	e8 ed f7 ff ff       	call   80107eef <lcr3>
...
80108723:	68 a3 92 10 80       	push   $0x801092a3
...
80108750:	e8 a5 f7 ff ff       	call   80107efa <v2p>
...
80108768:	e8 bb fc ff ff       	call   80108428 <mappages>
...
8010879c:	68 c0 92 10 80       	push   $0x801092c0
...
801087c3:	e8 c0 fb ff ff       	call   80108388 <walkpgdir>
...
801087d7:	68 e3 92 10 80       	push   $0x801092e3
...
8010881c:	e8 e6 f6 ff ff       	call   80107f07 <p2v>
...
801088a7:	68 01 93 10 80       	push   $0x80109301
...
801088ea:	e8 0b f6 ff ff       	call   80107efa <v2p>
...
80108906:	e8 1d fb ff ff       	call   80108428 <mappages>
...
8010895d:	e8 26 fa ff ff       	call   80108388 <walkpgdir>
...
801089f2:	68 1f 93 10 80       	push   $0x8010931f
...
80108a4c:	e8 b6 f4 ff ff       	call   80107f07 <p2v>
...
80108a93:	e8 f0 f8 ff ff       	call   80108388 <walkpgdir>
...
80108aa7:	68 30 93 10 80       	push   $0x80109330
...
80108af9:	e8 8a f8 ff ff       	call   80108388 <walkpgdir>
...
80108b0d:	68 3a 93 10 80       	push   $0x8010933a
...
80108b47:	e8 bb f3 ff ff       	call   80107f07 <p2v>
...
80108b6c:	e8 89 f3 ff ff       	call   80107efa <v2p>
...
80108b87:	e8 9c f8 ff ff       	call   80108428 <mappages>
...
80108bd6:	e8 ad f7 ff ff       	call   80108388 <walkpgdir>
...
80108c15:	e8 ed f2 ff ff       	call   80107f07 <p2v>
