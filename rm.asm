...
printf(int fd, char *fmt, ...)
{
 ...
 562:	75 07                	jne    56b <printf+0xe1>
          s = "(null)";
 564:	c7 45 f4 6b 08 00 00 	movl   $0x86b,-0xc(%ebp)
        while(*s != 0){
...
free(void *ap)
{
 ...
 629:	a1 dc 0a 00 00       	mov    0xadc,%eax
...
free(void *ap)
{
 ...
 6f4:	a3 dc 0a 00 00       	mov    %eax,0xadc
}
 6f9:	c9                   	leave  
 6fa:	c3                   	ret    
...
morecore(uint nu)
{
 ...
 751:	83 c4 10             	add    $0x10,%esp
  return freep;
 754:	a1 dc 0a 00 00       	mov    0xadc,%eax
}
 759:	c9                   	leave  
 75a:	c3                   	ret    
...
malloc(uint nbytes)
{
 ...
 76d:	89 45 ec             	mov    %eax,-0x14(%ebp)
  if((prevp = freep) == 0){
 770:	a1 dc 0a 00 00       	mov    0xadc,%eax
 775:	89 45 f0             	mov    %eax,-0x10(%ebp)
 778:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 77c:	75 23                	jne    7a1 <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
 77e:	c7 45 f0 d4 0a 00 00 	movl   $0xad4,-0x10(%ebp)
 785:	8b 45 f0             	mov    -0x10(%ebp),%eax
 788:	a3 dc 0a 00 00       	mov    %eax,0xadc
 78d:	a1 dc 0a 00 00       	mov    0xadc,%eax
 792:	a3 d4 0a 00 00       	mov    %eax,0xad4
    base.s.size = 0;
 797:	c7 05 d8 0a 00 00 00 	movl   $0x0,0xad8
 79e:	00 00 00 
  }
 ...
 7f4:	a3 dc 0a 00 00       	mov    %eax,0xadc
      return (void*)(p + 1);
 ...
 7ff:	eb 3b                	jmp    83c <malloc+0xe1>
    ...
    if(p == freep)
 801:	a1 dc 0a 00 00       	mov    0xadc,%eax
